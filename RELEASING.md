...
- Create and push a branch of CDT (e.g. `git fetch origin && git checkout origin/main -b cdt_12_5 && git push origin cdt_12_5`)
...
- wait for the build on the branch to complete that has this change https://ci.eclipse.org/cdt/job/cdt/job/cdt_12_5/
- test that the build works with simrel (See https://github.com/eclipse-simrel/ for details of simrel) by pointing cdt.aggrcon to the just-built p2 repo (e.g. https://download.eclipse.org/tools/cdt/builds/cdt/cdt_12_5/), updating versions and running validate aggregation
...
- Tag the release. Example: `git tag -a CDT_12_5_0 sha1ofpromotedbuild -m"CDT 12.5.0" && git push origin CDT_12_5_0`

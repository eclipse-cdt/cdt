...
public class TestGCCToolChain {
	 ...
	 */
	@Test
	public void gPlusPlusExe() throws Exception {
	 ...
	 * Tests:
	 * GCCToolChain(IToolChainProvider provider, Path pathToToolChain, String arch,	IEnvironmentVariable[] envVars)
	 * Where pathToToolChain=a/arm-none-eabi-gcc (a cross gcc tc with extension)
	 * Where envVars is null.
	 *
	 * Expected:
	 ...
	 */
	@Test
	public void crossExe() throws Exception {
	 ...
	 */
	@Test
	public void crossPlusPlusNoExt() throws Exception {

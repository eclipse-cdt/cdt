...
public class GCCUserToolChainProvider implements IUserToolChainProvider {
	...
	public void init(IToolChainManager manager) throws CoreException {
		...
		try {
			...
			throw new CoreException(new Status(IStatus.ERROR, Activator.getId(), "Loading toolchains file", e));
		}
	}
	...
	public void addToolChain(IToolChain toolChain) throws CoreException {
		if (!(toolChain instanceof GCCToolChain)) {
			throw new CoreException(new Status(IStatus.ERROR, Activator.getId(), "Not our toolchain"));
		}
		...
		try {
			...
			throw new CoreException(new Status(IStatus.ERROR, Activator.getId(), "Saving toolchains file", e));
		}

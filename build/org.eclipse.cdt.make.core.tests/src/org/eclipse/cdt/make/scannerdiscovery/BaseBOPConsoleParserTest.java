 ...
 * @author vhirsl
 */
public abstract class BaseBOPConsoleParserTest extends BaseTestCase {

	public static TestSuite suite() {
		return suite(BaseBOPConsoleParserTest.class);
	}

	protected IScannerInfoConsoleParser fOutputParser;
	protected IScannerInfoCollector fCollector;

	public BaseBOPConsoleParserTest(String name) {
		super(name);
	}

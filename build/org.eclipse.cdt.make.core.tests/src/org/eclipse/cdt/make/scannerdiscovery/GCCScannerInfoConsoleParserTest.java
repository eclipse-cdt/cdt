 ...
 * @author vhirsl
 */
public class GCCScannerInfoConsoleParserTest extends BaseBOPConsoleParserTest {

	public static TestSuite suite() {
		return suite(GCCScannerInfoConsoleParserTest.class);
	}

	public GCCScannerInfoConsoleParserTest(String name) {
		super(name);
	}

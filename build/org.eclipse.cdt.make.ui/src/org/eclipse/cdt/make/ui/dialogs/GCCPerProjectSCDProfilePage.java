...
public class GCCPerProjectSCDProfilePage extends AbstractDiscoveryPage {
	...
	public void createControl(Composite parent) {
		...
		String sipConsoleEnabledLabel = MakeUIPlugin
				.getResourceString("ScannerConfigOptionsDialog.siProvider.show.console.label"); //$NON-NLS-1$
	...
	protected boolean handleModifyOpenFileText() {
		String fileName = getBopOpenFileText();
		bopLoadButton
				.setEnabled(bopEnabledButton.getSelection() && fileName.length() > 0 && new File(fileName).exists());

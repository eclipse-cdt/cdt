...
public class CfgScannerConfigProfileManagerTest extends BaseTestCase {
	IProject fProject;

	public static Test suite() {
		TestSuite suite = new TestSuite(CfgScannerConfigProfileManagerTest.class.getName());
		suite.addTestSuite(CfgScannerConfigProfileManagerTest.class);
		return suite;
	}

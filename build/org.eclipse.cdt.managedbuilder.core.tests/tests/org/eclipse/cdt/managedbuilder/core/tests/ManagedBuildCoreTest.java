...
public class ManagedBuildCoreTest extends TestCase {
	private static IProjectType exeType;
	private static IProjectType libType;
	private static IProjectType dllType;

	public ManagedBuildCoreTest(String name) {
		super(name);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(ManagedBuildCoreTest.class.getName());
		suite.addTest(new ManagedBuildCoreTest("testLoadManifest"));
		suite.addTest(new ManagedBuildCoreTest("testTreeOptions"));
		suite.addTest(new ManagedBuildCoreTest("testOptionsAttributeUseByScannerDiscovery"));
		return suite;
	}

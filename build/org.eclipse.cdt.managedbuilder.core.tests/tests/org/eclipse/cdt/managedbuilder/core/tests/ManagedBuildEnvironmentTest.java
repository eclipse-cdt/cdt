 ...
 *
 * */
public class ManagedBuildEnvironmentTest extends TestCase {
	...
	public ManagedBuildEnvironmentTest() {
		super();
	}

	public ManagedBuildEnvironmentTest(String name) {
		super(name);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(ManagedBuildEnvironmentTest.class/*.getName()*/);
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvNotDef"));    //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvUpper"));	 //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvAppend"));	 //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvCWDPWD"));	 //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvSuppliers")); //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvGetPath"));   //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvSubscribe")); //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvGetParams")); //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvRemove"));    //$NON-NLS-1$
		//		suite.addTest(new ManagedBuildEnvironmentTest("testEnvProvider"));  //$NON-NLS-1$
		return suite;
	}
	...
	*/
	...
	private void doInit() {
		...
		proj = ManagedBuildMacrosTest.proj;
		assertNotNull(proj);
		mproj = ManagedBuildMacrosTest.mproj;
		assertNotNull(mproj);

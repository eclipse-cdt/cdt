...
public class OptionEnablementTest extends TestCase implements IManagedOptionValueHandler, IOptionApplicability {
	...
	public static Test suite() {
		return new TestSuite(OptionEnablementTest.class);
	}

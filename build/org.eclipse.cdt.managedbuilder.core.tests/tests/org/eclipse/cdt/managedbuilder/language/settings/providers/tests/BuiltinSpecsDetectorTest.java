...
public class BuiltinSpecsDetectorTest extends BaseTestCase {
	 ...
	 *
	 * Implementing ILanguageSettingsEditableProvider is to mimic the real GCCBuiltinSpecsDetector more
	 * closely, because ILanguageSettingsEditableProviders are treated specially by
	 * LanguageSettingsProvidersSerializer.cloneProviders().
	 */
	private class MockBuiltinSpecsDetectorEnvironmentChangeListener extends DummyBuiltinSpecsDetector implements ILanguageSettingsEditableProvider {

...
public class BuildBehaviourTab extends AbstractCBuildPropertyTab {
	...
	public void createControls(Composite parent) {
		...
		r_useStandardBuildArguments = setupRadio(grp_buildSettings, Messages.BuildBehaviourTab_Use_standard_build_arguments, 3,
				GridData.BEGINNING);
		...
		r_useCustomBuildArguments = setupRadio(grp_buildSettings, Messages.BuildBehaviourTab_Use_custom_build_arguments, 3, GridData.BEGINNING);

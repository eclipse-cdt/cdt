...
public class DefaultToolDetectionParticipant implements IToolDetectionParticipant {
	...
	@Override
	public DefaultToolDetectionParticipant.MatchResult basenameWithVersionMatches(String commandLine,
			boolean matchBackslash, String versionRegex) {
		if (matchBackslash && !canHandleNtfsPaths()) {
			return null;
		}
	...
	@Override
	public DefaultToolDetectionParticipant.MatchResult basenameWithExtensionMatches(String commandLine,
	...
	@Override
	public DefaultToolDetectionParticipant.MatchResult basenameWithVersionAndExtensionMatches(String commandLine,
			boolean matchBackslash, String versionRegex) {
		if (matchBackslash && !canHandleNtfsPaths()) {
			return null;
		}
	...
	private DefaultToolDetectionParticipant.MatchResult matcherMatches(Matcher matcher, String commandLine) {
		...
		if (matcher.lookingAt()) {
			return new DefaultToolDetectionParticipant.MatchResult(matcher.group(REGEX_GROUP_CMD),

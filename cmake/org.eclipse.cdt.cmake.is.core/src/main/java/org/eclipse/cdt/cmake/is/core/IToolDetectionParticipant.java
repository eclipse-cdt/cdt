...
public interface IToolDetectionParticipant {
	 ...
	 *         MatchResult holding the de-composed command-line is returned.
	 */
	MatchResult basenameWithVersionMatches(String commandLine, boolean matchBackslash, String versionRegex);
	 ...
	 *         MatchResult holding the de-composed command-line is returned.
	 */
	MatchResult basenameWithVersionAndExtensionMatches(String commandLine, boolean matchBackslash, String versionRegex);

...
public interface IBuiltinsOutputProcessor {
	...
	public interface IProcessingContext {
		/**
		 * Adds a ICLanguageSettingEntry to the result list. For convenience this method
		 * reports whether the new entry was {@code null}.
		 *
		 * @param entry the entry to add to the result list or {@code null}.
		 *
		 * @return {@code false} if {@code entry} was {@code null}, otherwise
		 *         {@code true}
		 */

...
public class BuiltinsCompilerCommandOptionPage extends AbstractLanguageSettingProviderOptionPage {
	...
	public void createControl(Composite parent) {
		...
		btnWithConsole = CompileCommandsJsonParserOptionPage.createCheckbox(composite, SWT.BEGINNING, 2,
				"&Allocate console in the Console View");
		btnWithConsole.setEnabled(enabled);
		btnWithConsole.setSelection(provider.isWithConsole());
		btnWithConsole.addSelectionListener(new SelectionAdapter() {
			@Override
	...
	public void performDefaults() {
		btnWithConsole.setSelection(false);
	}
}

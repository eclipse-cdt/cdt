...
public class CompileCommandsJsonParserOptionPage extends AbstractLanguageSettingProviderOptionPage {
	...
	public void performDefaults() {
		// normally should be handled by LanguageSettingsProviderTab
		btnVersionsEnabled.setSelection(false);
	}
	...
	public void createControl(Composite parent) {
		...
		btnVersionsEnabled.setEnabled(enabled);
		btnVersionsEnabled.setSelection(provider.isVersionPatternEnabled());
		{
		...
		pattern.setEnabled(enabled && btnVersionsEnabled.getSelection());

/*******************************************************************************
 * Copyright (c) 2016 Dominic Scharfe
...
public class QuickFixCreateNewClassTest {
	 ...
	 */
	@Test
	public void isApplicableForResolvableMarkerWithNotCLinkage() {
		when(translationUnitLanguage.getLinkageID()).thenReturn(23);
		assertTrue("Resolvable marker with ILinkage.C_LINKAGE_ID must not be applicable", qut.isApplicable(marker));
	}

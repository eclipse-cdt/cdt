...
public class CyclomaticComplexityChecker extends AbstractAstFunctionChecker {
	...
	@ProblemPreference(key = "countConditionalExpression", nls = MetricCheckersMessages.class)
	private boolean countConditionalExpression = true;
	...
	private boolean countAsPlusOne(IASTExpression expression) {
		if (expression instanceof IASTConditionalExpression) {
			return this.countConditionalExpression;
		}

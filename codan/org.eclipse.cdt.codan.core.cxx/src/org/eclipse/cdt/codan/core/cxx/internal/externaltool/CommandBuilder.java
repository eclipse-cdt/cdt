...
class CommandBuilder {
	...
	private String[] addFilePathToArgs(String actualFilePath, String[] configuredArgs) {
		...
		// Arrays.copyOf leaves empty cells at the end. We need an empty cell at the beginning of 
		// the array.
		System.arraycopy(configuredArgs, 0, allArgs, 1, argCount);
		// We add the path of the file to process as the first argument to pass.

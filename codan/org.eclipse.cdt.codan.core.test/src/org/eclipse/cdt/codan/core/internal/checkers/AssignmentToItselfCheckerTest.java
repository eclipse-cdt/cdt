...
public class AssignmentToItselfCheckerTest extends CheckerTestCase {
	...
	// = x;
	// }
	public void testMarkerOffset() { // Bug486610
		String code = getAboveComment();
		loadCodeAndRun(code);
		IMarker marker = checkErrorLine(2);
		// We need to add 1 because there is a space before "void" that is
		// removed by loadcode (trim).
		int start = marker.getAttribute(IMarker.CHAR_START, -1) + 1;

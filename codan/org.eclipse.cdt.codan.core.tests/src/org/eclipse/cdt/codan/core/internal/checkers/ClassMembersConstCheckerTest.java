...
public class ClassMembersConstCheckerTest extends CheckerTestCase {
	...
	//struct B {
	//    int member;
	//    ConstInt& get_member_ref() {
	//        return member;
	//    }
	//};
	public void testWithReturnByIndirectConstRef() throws Exception {
		loadCodeAndRun(getAboveComment());
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeUsedInStatic);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeWritten);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MethodShouldBeStatic);
		checkErrorLine(4, ClassMembersConstChecker.ER_ID_MethodShouldBeConst);
	}

	//using IntRef = int&;
	//struct B {
	//    int member;
	//    IntRef get_member_ref() {
	//        return member;
	//    }
	//};
	public void testWithReturnByIndirectNoConstRef() throws Exception {
		loadCodeAndRun(getAboveComment());
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeUsedInStatic);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeWritten);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MethodShouldBeStatic);
	...
	//	}
	//};
	public void testWithCast() throws Exception {
		loadCodeAndRun(getAboveComment());
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeUsedInStatic);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeWritten);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MethodShouldBeStatic);
	...
	//	}
	//};
	public void testReturnInitList() throws Exception {
		loadCodeAndRun(getAboveComment());
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeUsedInStatic);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeWritten);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MethodShouldBeStatic);
	...
	//	}
	//};
	public void testWithFunctionTemplate() throws Exception {
		loadCodeAndRun(getAboveComment());
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeUsedInStatic);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MemberCannotBeWritten);
		checkNoErrorsOfKind(ClassMembersConstChecker.ER_ID_MethodShouldBeStatic);

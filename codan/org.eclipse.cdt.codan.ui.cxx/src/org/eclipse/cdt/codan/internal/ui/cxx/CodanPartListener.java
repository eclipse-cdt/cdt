...
/**
 * Part listener that does the following on a opened {@code CEditor}:
 * <ol>
 * <li>installs a <code>{@link CodanCReconciler}</code></li>
 * <li>installs a <code>{@link IPostSaveListener}</code> that runs checkers that are enabled
 * in "run on file save" launch mode</li>
 * <li>runs checkers enabled in "run on file open" launch mode</li>
 * </ol>
 */

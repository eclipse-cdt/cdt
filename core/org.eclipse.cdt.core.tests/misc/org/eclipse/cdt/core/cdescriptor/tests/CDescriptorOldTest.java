...
/**
 * This class exists because the tests in CDescriptorTest
 * are not fixed.
 * This class corresponds to the version of
 * CDescrptorTests before the changes made in cdt.core 5.1
 * (CVS version 1.12)
 */
public class CDescriptorOldTest extends TestCase {
	 ...
	 * @param name
	 */
	public CDescriptorOldTest(String name) {
		super(name);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(CDescriptorOldTest.class.getName());

		suite.addTest(new CDescriptorOldTest("testDescriptorCreation"));
		suite.addTest(new CDescriptorOldTest("testDescriptorOwner"));
		suite.addTest(new CDescriptorOldTest("testExtensionCreation"));
		suite.addTest(new CDescriptorOldTest("testExtensionGet"));
		suite.addTest(new CDescriptorOldTest("testExtensionData"));
		suite.addTest(new CDescriptorOldTest("testExtensionRemove"));
		suite.addTest(new CDescriptorOldTest("testProjectDataCreate"));
		suite.addTest(new CDescriptorOldTest("testProjectDataDelete"));
		suite.addTest(new CDescriptorOldTest("testConcurrentDescriptorCreation"));
		suite.addTest(new CDescriptorOldTest("testConcurrentDescriptorCreation2"));
		suite.addTest(new CDescriptorOldTest("testDeadlockDuringProjectCreation"));
		suite.addTest(new CDescriptorOldTest("testProjectStorageDelete"));

 ...
 *
 * Contributors:
 *     Andrew Gvozdev (Quoin Inc.) - initial API and implementation, based on GCCErrorParserTest
 *******************************************************************************/
 ...
 */
public class MakeErrorParserTest extends GenericErrorParserTest {
	...
	public MakeErrorParserTest() {
		super();
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(MakeErrorParserTest.class);
		return suite;
	}

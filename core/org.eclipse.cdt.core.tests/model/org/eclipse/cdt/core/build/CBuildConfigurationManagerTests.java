...
public class CBuildConfigurationManagerTests extends BaseTestCase5 {
	 ...
	 * IBuildConfigurations with a valid ICBuildConfiguration pendant will be removed from
	...
	public void testNoConfigs() throws Exception {
		...
		assertThat("bConfig is expect to be null", cbConfig == null);
		...
		// Get the ICBuildconfiguration pendant
		cbConfig = buildConfiguration.getAdapter(ICBuildConfiguration.class);
		assertThat("A valid ICBuildconfiguration counterpart is found", cbConfig == cBuildConfig);
	}

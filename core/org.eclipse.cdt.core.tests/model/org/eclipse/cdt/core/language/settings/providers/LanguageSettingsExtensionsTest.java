 ...
 */
public class LanguageSettingsExtensionsTest extends BaseTestCase {
	 ...
	 */
	public LanguageSettingsExtensionsTest(String name) {
		super(name);
	...
	public static TestSuite suite() {
		return new TestSuite(LanguageSettingsExtensionsTest.class);
	}

...
public class CModelElementsTest extends BaseTestCase {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(CModelElementsTest.class.getName());
		suite.addTest(new CModelElementsTest("testCModelElements"));
		return suite;
	}

	public CModelElementsTest(String name) {
		super(name);
	}

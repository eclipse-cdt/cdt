 ...
 */
public class ElementDeltaTest extends TestCase implements IElementChangedListener {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(ElementDeltaTest.class.getName());
		suite.addTest(new ElementDeltaTest("testElementDeltas"));
		return suite;
	}

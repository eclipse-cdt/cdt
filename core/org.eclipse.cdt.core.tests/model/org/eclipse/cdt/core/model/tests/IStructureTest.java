 ...
 * @author bnicolle
 */
public class IStructureTest extends IntegratedCModelTest {
	/**
	 * @param name
	 */
	public IStructureTest(String name) {
		super(name);
	}
	...
	public static Test suite() {
		...
		// Interface tests:
		suite.addTest(new IStructureTest("testGetChildrenOfTypeStruct"));
		suite.addTest(new IStructureTest("testGetChildrenOfTypeClass")); // C++ only
		suite.addTest(new IStructureTest("testGetFields"));
		//Bug# 38985: solved. suite.addTest(new IStructureTest("testGetFieldsHack"));
		suite.addTest(new IStructureTest("testGetField"));
		suite.addTest(new IStructureTest("testGetMethods")); // C++ only
		//Bug# 38985: solved. suite.addTest(new IStructureTest("testGetMethodsHack")); // C++ only
		suite.addTest(new IStructureTest("testGetMethod")); // C++ only
		suite.addTest(new IStructureTest("testIsStruct"));
		suite.addTest(new IStructureTest("testIsClass")); // C++ only
		suite.addTest(new IStructureTest("testIsUnion"));
		suite.addTest(new IStructureTest("testIsAbstract")); // C++ only
		suite.addTest(new IStructureTest("testGetBaseTypes")); // C++ only
		suite.addTest(new IStructureTest("testGetAccessControl")); // C++ only

		// Language Specification tests:
		suite.addTest(new IStructureTest("testAnonymousStructObject"));
		suite.addTest(new IStructureTest("testInnerStruct"));

 ...
 *
 */
public class ITemplateTest extends IntegratedCModelTest {
	/**
	 * @param name
	 */
	public ITemplateTest(String name) {
		super(name);
	}
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(IStructureTest.class.getName());

		// Interface tests:
		suite.addTest(new ITemplateTest("testGetChildrenOfTypeTemplate"));
		suite.addTest(new ITemplateTest("testGetNumberOfTemplateParameters"));
		suite.addTest(new ITemplateTest("testGetTemplateParameterTypes"));
		suite.addTest(new ITemplateTest("testGetTemplateSignature"));

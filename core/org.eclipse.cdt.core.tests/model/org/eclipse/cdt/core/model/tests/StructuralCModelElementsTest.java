...
public class StructuralCModelElementsTest extends BaseTestCase {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(StructuralCModelElementsTest.class.getName());
		suite.addTest(new StructuralCModelElementsTest("testCModelElements")); //$NON-NLS-1$
		return suite;
	}

	public StructuralCModelElementsTest(String name) {
		super(name);
	}

 ...
 *
 */
public class StructuralStructureTest extends IStructureTest {
	/**
	 * @param name
	 */
	public StructuralStructureTest(String name) {
		super(name);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(StructuralStructureTest.class.getName());

		// TODO check C-only behaviour using C_NATURE vs CC_NATURE

		// Interface tests:
		suite.addTest(new StructuralStructureTest("testGetChildrenOfTypeStruct"));
		suite.addTest(new StructuralStructureTest("testGetChildrenOfTypeClass")); // C++ only
		suite.addTest(new StructuralStructureTest("testGetFields"));
		suite.addTest(new StructuralStructureTest("testGetField"));
		suite.addTest(new StructuralStructureTest("testGetMethods")); // C++ only
		suite.addTest(new StructuralStructureTest("testGetMethod")); // C++ only
		suite.addTest(new StructuralStructureTest("testIsStruct"));
		suite.addTest(new StructuralStructureTest("testIsClass")); // C++ only
		suite.addTest(new StructuralStructureTest("testIsUnion"));
		suite.addTest(new StructuralStructureTest("testIsAbstract")); // C++ only
		suite.addTest(new StructuralStructureTest("testGetBaseTypes")); // C++ only
		suite.addTest(new StructuralStructureTest("testGetAccessControl")); // C++ only

		// Language Specification tests:
		suite.addTest(new StructuralStructureTest("testAnonymousStructObject"));
		suite.addTest(new StructuralStructureTest("testInnerStruct"));

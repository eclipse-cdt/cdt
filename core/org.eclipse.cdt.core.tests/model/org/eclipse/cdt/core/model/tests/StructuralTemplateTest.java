 ...
 *
 */
public class StructuralTemplateTest extends ITemplateTest {
	/**
	 * @param name
	 */
	public StructuralTemplateTest(String name) {
		super(name);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(StructuralTemplateTest.class.getName());

		// Interface tests:
		suite.addTest(new StructuralTemplateTest("testGetChildrenOfTypeTemplate"));
		suite.addTest(new StructuralTemplateTest("testGetNumberOfTemplateParameters"));
		suite.addTest(new StructuralTemplateTest("testGetTemplateParameterTypes"));
		suite.addTest(new StructuralTemplateTest("testGetTemplateSignature"));

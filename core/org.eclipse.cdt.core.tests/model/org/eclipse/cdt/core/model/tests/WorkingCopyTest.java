...
public class WorkingCopyTest extends TestCase {
	...
	public static void main(String[] args) {
		TestPluginLauncher.run(TestPluginLauncher.getLocationFromProperties(), WorkingCopyTest.class, args);
	}

	public static Test suite() {
		TestSuite suite = new TestSuite(WorkingCopyTest.class.getName());
		suite.addTest(new WorkingCopyTest("testWorkingCopy"));
		//suite.addTest(new WorkingCopyTest("testHashing"));
		return suite;
	}

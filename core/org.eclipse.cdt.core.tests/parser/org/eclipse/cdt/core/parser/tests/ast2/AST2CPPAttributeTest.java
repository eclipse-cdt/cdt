...
public class AST2CPPAttributeTest extends AST2TestBase {

	public AST2CPPAttributeTest() {
	}

	public AST2CPPAttributeTest(String name) {
		super(name);
	}

	public static TestSuite suite() {
		return suite(AST2CPPAttributeTest.class);
	}

 ...
 * interfaces.
 */
public class AST2CPPImplicitNameTest extends AST2TestBase {

	public AST2CPPImplicitNameTest() {
	}

	public AST2CPPImplicitNameTest(String name) {
		super(name);
	}

	public static TestSuite suite() {
		return suite(AST2CPPImplicitNameTest.class);
	}

...
//		ICPPField c = bh.assertNonProblemOnFirstIdentifier(".c[4 ... 6]");
	...
	//	decltype(auto) const m = 42; // Error - decltype(auto) does not allow type specifiers.
	//	decltype(auto) volatile n = 42; // Error - decltype(auto) does not allow type specifiers.
	//	decltype(auto) const volatile o = 42; // Error - decltype(auto) does not allow type specifiers.
	...
	//	}
	//  auto a = foo();
	public void testDecltypeAutoTrailingReturnTypeConst() throws Exception {
		String code = getAboveComment();
		BindingAssertionHelper bh = new AST2AssertionHelper(code, true);
		ICPPVariable a = bh.assertNonProblem("a =", 1);
	...
	//	}
	//  auto a = foo();
	public void testDecltypeAutoTrailingReturnTypeVolatile() throws Exception {
		String code = getAboveComment();
		BindingAssertionHelper bh = new AST2AssertionHelper(code, true);
		ICPPVariable a = bh.assertNonProblem("a =", 1);
		IProblemType aType = (IProblemType) a.getType();
	...
	//	}
	//  decltype(auto) a = foo();
	public void testDecltypeAutoTrailingReturnTypeConstDecltype() throws Exception {
		String code = getAboveComment();
		BindingAssertionHelper bh = new AST2AssertionHelper(code, true);
		ICPPVariable a = bh.assertNonProblem("a =", 1);
		IProblemType aType = (IProblemType) a.getType();

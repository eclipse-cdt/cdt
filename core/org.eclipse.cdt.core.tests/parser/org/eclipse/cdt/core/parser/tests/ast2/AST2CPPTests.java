...
public class AST2CPPTests extends AST2CPPTestBase {
	...
	//  constexpr bool aggregate_init_is_noexcept = noexcept(myaggregate{{1}});
	//  constexpr bool aggregate_init_is_not_noexcept = noexcept(myaggregate{{my_int}});
	//  constexpr bool aggregate_access_is_noexcept = noexcept(agg.a);
	//  constexpr bool not_noexcept_conditional = noexcept(condition() ? fun() : fun_noexcept());
	//  constexpr bool is_noexcept_conditional = noexcept(condition() ? fun_noexcept() : fun_noexcept());
	...
	public void testNoexceptOperator2_545021() throws Exception {
		BindingAssertionHelper helper = getAssertionHelper();
		helper.assertVariableValue("unevaluated_fun_is_noexcept", 1);
	...
	//  constexpr bool noexcept_unaryop_is_noexcept = noexcept(t2 = 1);
	public void testNoexceptOperator3_545021() throws Exception {
		BindingAssertionHelper helper = getAssertionHelper();
	...
	public void testNoexceptOperator4_545021() throws Exception {
		BindingAssertionHelper helper = getAssertionHelper();
	...
	public void testNoexceptOperator5_545021() throws Exception {
		BindingAssertionHelper helper = getAssertionHelper();
		helper.assertVariableValue("is_noexcept", 1);
	}

...
public class AST2CPPTests extends AST2TestBase {
	...
	protected IASTTranslationUnit parseAndCheckBindings(String code) throws Exception {
		return parseAndCheckBindings(code, CPP, false, true);
	}

	protected IASTTranslationUnit parseAndCheckBindings(String code, ParserLanguage lang, boolean useGNUExtensions,
			boolean expectNoProblems) throws Exception {
	...
	public void testAttributeInUsingDirective_351228() throws Exception {
		parseAndCheckBindings(getAboveComment(), CPP, true, true);
	}

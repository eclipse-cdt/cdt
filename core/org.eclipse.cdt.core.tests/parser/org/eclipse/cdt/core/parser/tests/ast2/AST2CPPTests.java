...
public class AST2CPPTests extends AST2TestBase {
	...
	//	  f("aaa"MACRO);
	//	}
	public void testStringConcatenationWithMacroC() throws Exception {
	...
	//	  f("aaa"MACRO);
	//	}
	public void testStringConcatenationWithMacroCPP() throws Exception {
		IASTTranslationUnit tu = parseAndCheckBindings(getAboveComment(), CPP);
		IASTFunctionDefinition testFn = (IASTFunctionDefinition) tu.getDeclarations()[1];
		IASTCompoundStatement fnBody = (IASTCompoundStatement) testFn.getBody();
		IASTFunctionCallExpression fnCall = (IASTFunctionCallExpression) ((IASTExpressionStatement)fnBody.getStatements()[0]).getExpression();
		IASTLiteralExpression arg = (IASTLiteralExpression) fnCall.getArguments()[0];

...
public class AST2TemplateTests extends AST2TestBase {
	...
	public void testTemplatedAliasDeclarationValueArgument() throws Exception {
		...
		assertEquals(buffRef.getTemplateParameterMap().getArgument(0).getNonTypeValue().numericalValue(), Long.valueOf(4));
		assertEquals(buffRef.getTemplateParameterMap().getArgument(1).getNonTypeValue().numericalValue(), Long.valueOf(5));
	}

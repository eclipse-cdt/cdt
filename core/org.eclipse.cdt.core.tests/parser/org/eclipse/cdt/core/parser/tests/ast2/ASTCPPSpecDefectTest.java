...
public class ASTCPPSpecDefectTest extends AST2TestBase {

	public ASTCPPSpecDefectTest() {
	}

	public ASTCPPSpecDefectTest(String name) {
		super(name);
	}

	public static TestSuite suite() {
		return suite(ASTCPPSpecDefectTest.class);
	}

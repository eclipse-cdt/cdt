 ...
 */
public class ASTInactiveCodeTest extends AST2TestBase {

	public static TestSuite suite() {
		return suite(ASTInactiveCodeTest.class);
	}

	public ASTInactiveCodeTest() {
		super();
	}

	public ASTInactiveCodeTest(String name) {
		super(name);
	}

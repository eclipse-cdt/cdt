 ...
 * @author jcamelon
 */
public class CompleteParser2Test extends BaseTestCase {
	private static final NullLogService NULL_LOG = new NullLogService();

	public CompleteParser2Test() {
	}

	public CompleteParser2Test(String name) {
		super(name);
	}

	public static TestSuite suite() {
		return suite(CompleteParser2Test.class);
	}

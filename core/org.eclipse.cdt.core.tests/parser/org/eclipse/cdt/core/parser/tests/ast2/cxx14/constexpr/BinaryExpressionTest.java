...
public class BinaryExpressionTest extends TestBase {
	public static class NonIndexing extends BinaryExpressionTest {
		public NonIndexing() {
	...
	public static class SingleProject extends BinaryExpressionTest {

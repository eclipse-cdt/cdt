...
public class BinaryOperatorOverloadingTest extends TestBase {
	public static class NonIndexing extends BinaryOperatorOverloadingTest {
		public NonIndexing() {
	...
	public static class SingleProject extends BinaryOperatorOverloadingTest {

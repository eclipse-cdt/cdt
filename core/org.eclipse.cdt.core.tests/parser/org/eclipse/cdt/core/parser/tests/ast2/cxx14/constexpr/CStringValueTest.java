...
public class CStringValueTest extends TestBase {
	public static class NonIndexing extends CStringValueTest {
		public NonIndexing() {
	...
	public static class SingleProject extends CStringValueTest {

...
public class ClassTemplateTest extends TestBase {
	public static class NonIndexing extends ClassTemplateTest {
		public NonIndexing() {
	...
	public static class SingleProject extends ClassTemplateTest {

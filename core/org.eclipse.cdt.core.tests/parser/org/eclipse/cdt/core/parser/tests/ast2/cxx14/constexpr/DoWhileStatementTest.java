...
public class DoWhileStatementTest extends TestBase {
	public static class NonIndexing extends DoWhileStatementTest {
		public NonIndexing() {
	...
	public static class SingleProject extends DoWhileStatementTest {

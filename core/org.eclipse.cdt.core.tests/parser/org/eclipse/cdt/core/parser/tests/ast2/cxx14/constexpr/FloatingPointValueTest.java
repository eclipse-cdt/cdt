...
public class FloatingPointValueTest extends TestBase {
	public static class NonIndexing extends FloatingPointValueTest {
		public NonIndexing() {
	...
	public static class SingleProject extends FloatingPointValueTest {

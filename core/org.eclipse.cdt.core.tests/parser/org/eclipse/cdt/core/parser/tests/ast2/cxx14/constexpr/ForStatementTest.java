...
public class ForStatementTest extends TestBase {
	public static class NonIndexing extends ForStatementTest {
		public NonIndexing() {
	...
	public static class SingleProject extends ForStatementTest {

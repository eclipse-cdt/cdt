...
public class IntegralValueTest extends TestBase {
	public static class NonIndexing extends IntegralValueTest {
		public NonIndexing() {
	...
	public static class SingleProject extends IntegralValueTest {

...
public class MemberFunctionTest extends TestBase {
	public static class NonIndexing extends MemberFunctionTest {
		public NonIndexing() {
	...
	public static class SingleProject extends MemberFunctionTest {

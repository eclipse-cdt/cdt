...
public class MemberVariableTest extends TestBase {
	public static class NonIndexing extends MemberVariableTest {
		public NonIndexing() {
	...
	public static class SingleProject extends MemberVariableTest {

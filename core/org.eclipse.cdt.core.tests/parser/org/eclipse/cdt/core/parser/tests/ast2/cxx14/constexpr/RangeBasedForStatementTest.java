...
public class RangeBasedForStatementTest extends TestBase {
	public static class NonIndexing extends RangeBasedForStatementTest {
		public NonIndexing() {
	...
	public static class SingleProject extends RangeBasedForStatementTest {

...
public class StructuredBindingTest extends TestBase {
	public static class NonIndexing extends StructuredBindingTest {
		public NonIndexing() {
	...
	public static class SingleProject extends StructuredBindingTest {

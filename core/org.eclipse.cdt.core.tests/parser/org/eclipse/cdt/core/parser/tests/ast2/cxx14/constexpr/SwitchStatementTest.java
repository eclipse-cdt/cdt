...
public class SwitchStatementTest extends TestBase {
	public static class NonIndexing extends SwitchStatementTest {
		public NonIndexing() {
	...
	public static class SingleProject extends SwitchStatementTest {

...
public class TypeAliasTest extends TestBase {
	public static class NonIndexing extends TypeAliasTest {
		public NonIndexing() {
	...
	public static class SingleProject extends TypeAliasTest {

...
public class UnaryExpressionTest extends TestBase {
	public static class NonIndexing extends UnaryExpressionTest {
		public NonIndexing() {
	...
	public static class SingleProject extends UnaryExpressionTest {

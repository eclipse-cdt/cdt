...
public class UnaryOperatorOverloadingTest extends TestBase {
	public static class NonIndexing extends UnaryOperatorOverloadingTest {
		public NonIndexing() {
	...
	public static class SingleProject extends UnaryOperatorOverloadingTest {

...
public class UserDefinedLiteralTest extends TestBase {
	public static class NonIndexing extends UserDefinedLiteralTest {
		public NonIndexing() {
	...
	public static class SingleProject extends UserDefinedLiteralTest {

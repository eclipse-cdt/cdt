...
public class WhileStatementTest extends TestBase {
	public static class NonIndexing extends WhileStatementTest {
		public NonIndexing() {
	...
	public static class SingleProject extends WhileStatementTest {

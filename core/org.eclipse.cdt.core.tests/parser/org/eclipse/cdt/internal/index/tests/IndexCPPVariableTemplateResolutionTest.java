...
public class IndexCPPVariableTemplateResolutionTest extends IndexBindingResolutionTestBase {
	...
	public void testExplicitVariableInstance() {
		checkBindings();
		ICPPVariableTemplate pi = getBindingFromASTName("pi", 0);
		ICPPVariableInstance piOfInt = getBindingFromASTName("pi<int>", 0, ICPPVariableInstance.class, IIndexBinding.class);
	...
	public void testExplicitFieldInstance() {
		checkBindings();
		ICPPFieldTemplate pi = getBindingFromASTName("pi", 0);
		ICPPVariableInstance piOfDouble = getBindingFromASTName("pi<double>", 0, ICPPVariableInstance.class, ICPPField.class, IIndexBinding.class);
	...
	public void testFieldSpecializationInRef() {
		checkBindings();
		ICPPVariableInstance piOfDouble = getBindingFromASTName("pi<double>", 0, ICPPVariableInstance.class, ICPPField.class);
	}
	...
	public void testVariableTemplatePartialSpecialization() {
		...
		assertInstance(cOfFloat.getSpecializedBinding(), ICPPVariableTemplatePartialSpecialization.class, IIndexBinding.class);
		
		assertEquals(c, ((ICPPVariableTemplatePartialSpecialization) cOfFloat.getSpecializedBinding()).getPrimaryTemplate());
	}
	...
	public void testVariableTemplatePartialSpecialization2() {
		...
		assertInstance(cOfIntPtr.getSpecializedBinding(), ICPPVariableTemplatePartialSpecialization.class, IIndexBinding.class);
		
		assertEquals(c, ((ICPPVariableTemplatePartialSpecialization) cOfIntPtr.getSpecializedBinding()).getPrimaryTemplate());
	}
	...
	public void testFieldTemplatePartialSpecialization() {
		...
		assertInstance(cOfIntPtr.getSpecializedBinding(), ICPPVariableTemplatePartialSpecialization.class, IIndexBinding.class, ICPPField.class);
		
		assertEquals(c.getClass(), ((ICPPVariableTemplatePartialSpecialization) cOfIntPtr.getSpecializedBinding()).getPrimaryTemplate().getClass());
	}
}

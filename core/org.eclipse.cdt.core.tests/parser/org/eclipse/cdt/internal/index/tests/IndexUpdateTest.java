...
public class IndexUpdateTest extends IndexTestBase {
	...
	public static TestSuite suite() {
		TestSuite suite = suite(IndexUpdateTest.class, "_");
		suite.addTest(new IndexUpdateTest("deleteProject"));
		return suite;
	}
	...
	public IndexUpdateTest(String name) {
		super(name);
	}

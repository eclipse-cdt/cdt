...
public abstract class AbstractBuildCommandParser extends AbstractLanguageSettingsOutputScanner {
	public static final Object JOB_FAMILY_BUILD_COMMAND_PARSER = CCorePlugin.PLUGIN_ID + ".AbstractBuildCommandParser"; //$NON-NLS-1$
	 ...
	 */
	public ResourceScope getRcScope() {
	 ...
	 *    <br>- {@code AbstractBuildCommandParser.ResourceScope.PROJECT} - apply entries to the project level.
	 */
	public void setRcScope(ResourceScope rcScope) {

...
public class CDataFactory {
	...
	public CFileData createFileData(CConfigurationData cfg, CResourceData base, CLanguageData lBase, String id,
	...
	public CTargetPlatformData createTargetPlatformData(CConfigurationData cfg, CTargetPlatformData base, String id,
			String name, boolean clone) {
		if (id == null)
			id = clone ? base.getId() : CDataUtil.genId(cfg.getId());

			...
			if (DATA_PROVIDER.equals(element.getName())) {
				...
				if (obj instanceof CConfigurationDataProvider) {
					...
					throw ExceptionFactory.createCoreException(
							SettingsModelMessages.getString("CConfigurationDataProviderDescriptor.1")); //$NON-NLS-1$
			}
		}
		throw ExceptionFactory
				.createCoreException(SettingsModelMessages.getString("CConfigurationDataProviderDescriptor.2")); //$NON-NLS-1$
	}

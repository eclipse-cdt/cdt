...
public final class BaseOption<V> implements OptionMetadata<V> {
	...
	public BaseOption(Class<V> clazz, String identifier, V defaultValue, String name, String description) {
		...
		Objects.requireNonNull(defaultValue, OptionMessages.BaseOption_e_null_name);
		Objects.requireNonNull(defaultValue, OptionMessages.BaseOption_e_null_description);
		this.clazz = clazz;

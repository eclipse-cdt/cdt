...
public interface IScannerExtensionConfiguration {
	 ...
	 * <p>
	 * Please not that this option conflicts with
	 * {@link #supportAtSignOperator()}, and both may thus not simultaneously
	 * enabled.
	 * 
	 * @return <code>true</code>, if @ should be supported in identifiers
	 * @since 5.1
	 ...
	 *  <p>
	 * Please not that this option conflicts with
	 * {@link #support$InIdentifiers()}, and both may thus not simultaneously
	 * enabled.
	 * 

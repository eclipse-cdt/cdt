...
public interface IProblem {
	...
	/**
	 * Invalid (marco) suffix on literal. C++11 requires a space between literal
	 * and string macro
	 * @since 5.9
	 */
	public final static int PREPROCESS_INVALID_USER_DEFINED_SUFFIX = PREPROCESSOR_RELATED | 0x011;

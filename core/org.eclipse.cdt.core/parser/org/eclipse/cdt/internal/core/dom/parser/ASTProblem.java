...
public class ASTProblem extends ASTNode implements IASTProblem {
    ...
    static {
    	...
    	errorMessages.put(new Integer(PREPROCESS_INVALID_USER_DEFINED_SUFFIX),
    			ParserMessages.getString("ScannerProblemFactory.error.preproc.invalidUserDefinedLiteralSuffix")); //$NON-NLS-1$

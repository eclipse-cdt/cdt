...
public abstract class AbstractGNUSourceCodeParser implements ISourceCodeParser {
    ...
    protected IASTStatement parseDeclarationOrExpressionStatement(List<IASTAttributeSpecifier> attributeSpecifiers)
        ...
        try {
            ...
            addSpecifiers(attributeSpecifiers, expressionStatement);
        ...
        try {
            ...
            if (d instanceof IASTAttributeOwner) {
                addSpecifiers(attributeSpecifiers, (IASTAttributeOwner) d);
            }
	...
	protected void addSpecifiers(List<IASTAttributeSpecifier> specifiers, IASTAttributeOwner owner) {

...
public class CPPASTStructuredBindingDeclaration extends CPPASTSimpleDeclaration
	...
	public IASTImplicitName[] getImplicitNames() {
		if (implicitInitializerName == null) {
			...
			IType initializerType = SemanticUtil.getNestedType(type, SemanticUtil.REF);
			...
			CPPImplicitVariable implicitInitializerVariable = new CPPImplicitVariable(implicitInitializerName,

...
public class CPPASTTranslationUnit extends ASTTranslationUnit implements ICPPASTTranslationUnit, IASTAmbiguityParent {
	...
	private final Map<ICPPTemplateInstance, String> fTemplateArgListStringCache = new HashMap<>(); // unnormalized
	private final Map<ICPPTemplateInstance, String> fNormalizedTemplateArgListStringCache = new HashMap<>();
	...
	public Map<ICPPTemplateInstance, String> getTemplateArgumentListStringCache(boolean normalized) {
		return normalized ? fNormalizedTemplateArgListStringCache : fTemplateArgListStringCache;
	}

...
public class CPPInheritance {
	...
	public static class FinalOverriderMap {
		...
		/**
		 * Merge the overriders from 'source' into 'target'.
		 * Exclude methods in 'source' which themselves have an overrider in 'target'.
		 */
	 ...
	 * given class, return that final overrider. Otherwise, return null. 

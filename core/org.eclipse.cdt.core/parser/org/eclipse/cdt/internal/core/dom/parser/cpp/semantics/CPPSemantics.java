...
public class CPPSemantics {
	 ...
	 * in the given scope.
	 */
	public static IBinding[] findBindingsForQualifiedName(IScope scope, String qualifiedName, IASTNode point) {
		...
		findBindingsForQualifiedName(scope, qualifiedName, bindings, point);
	...
	private static void findBindingsForQualifiedName(IScope scope, String qualifiedName, Collection<IBinding> bindings,
		...
		if (part2 == null || part2.isEmpty()) {
			bindings.addAll(Arrays.asList(findBindings(scope, part1.toCharArray(), false, point)));
			return;
		}

		// Find all bindings that match the first part of the name.  For each such binding,
		// lookup the second part of the name.
		for (IBinding binding : findBindings(scope, part1.toCharArray(), false, point)) {
			IScope lookupScope;
			...
			findBindingsForQualifiedName(lookupScope, part2, bindings, point);
		}
	}

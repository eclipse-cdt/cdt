...
public class CPPSemantics {
	...
	private static final ThreadLocal<Stack<IASTNode>> fLookupPoints = new ThreadLocal<Stack<IASTNode>>() {
		@Override
		protected Stack<IASTNode> initialValue() {
			return new Stack<>();
		}
	};
	...
	public static IASTNode getCurrentLookupPoint() {
		Stack<IASTNode> lookupPoints = fLookupPoints.get();

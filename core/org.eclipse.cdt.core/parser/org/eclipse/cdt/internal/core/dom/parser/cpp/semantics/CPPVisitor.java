...
public class CPPVisitor extends ASTQueries {
	...
	private static IType getBaseType(IASTDeclSpecifier declSpec) {
		...
		} else if (declSpec instanceof ICPPASTTypeTraitSpecifier) {
			ICPPASTTypeTraitSpecifier spec = (ICPPASTTypeTraitSpecifier) declSpec;
			return new CPPTypeTraitType(spec.getOperator(), createType(spec.getOperand()));

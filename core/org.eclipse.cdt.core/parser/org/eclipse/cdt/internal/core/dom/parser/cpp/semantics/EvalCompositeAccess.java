...
public class EvalCompositeAccess implements ICPPEvaluation {
	...
	private ICPPEvaluation getValue() {
	...
	public ICPPEvaluation computeForFunctionCall(ActivationRecord record, ConstexprEvaluationContext context) {
		if(getValue() != EvalFixed.INCOMPLETE) {
			return getValue().computeForFunctionCall(record, context);
		} else {
	...
	public IBinding getTemplateDefinition() {
		return getValue().getTemplateDefinition();
	}

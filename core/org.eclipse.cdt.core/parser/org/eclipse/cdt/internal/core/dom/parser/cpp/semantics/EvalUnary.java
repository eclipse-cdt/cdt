...
public class EvalUnary extends CPPEvaluation {
	private static final ICPPEvaluation ZERO_EVAL = new EvalFixed(CPPSemantics.INT_TYPE, PRVALUE, Value.create(0), null);
	...
	private ICPPFunction computeOverload(IASTNode point) {
    	...
    	return CPPSemantics.findOverloadedOperator(getLookupContext(point), args, type, op, LookupMode.LIMITED_GLOBALS);
	}

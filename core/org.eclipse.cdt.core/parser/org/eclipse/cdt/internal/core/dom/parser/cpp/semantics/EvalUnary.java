...
public class EvalUnary extends CPPDependentEvaluation {
	...
	public IValue getValue() {
		...
		case op_noexcept:
			// [expr.unary.noexcept]
			// The result of the noexcept operator is false
			// if in a potentially-evaluated context the expression would contain

			// - a potentially evaluated call to a function, member function, function pointer, or member function
			//   pointer that does not have a non-throwing exception-specification unless the call is a constant
			//   expression

...
public class EvalUtil {	
	public static IValue getConditionExprValue(ICPPEvaluation conditionExrEval, ActivationRecord record, ConstexprEvaluationContext context) {
		return conditionExrEval.computeForFunctionCall(record, context.recordStep()).getValue(null);
	}
	...
	public static IValue getConditionDeclValue(ExecSimpleDeclaration conditionDeclExec, ActivationRecord record, ConstexprEvaluationContext context) {
		...
		return record.getVariable(declaredBinding).computeForFunctionCall(record, context).getValue(null);
	}
	...
	public static ICPPExecution executeStatement(IASTStatement stmt, ActivationRecord record, ConstexprEvaluationContext context) {
		ICPPExecution stmtExec = getExecutionFromStatement(stmt);
		return executeStatement(stmtExec, record, context);
	}
	...
	public static boolean isCompilerGeneratedCtor(IBinding ctor) {
		...
		return ctor instanceof CPPImplicitConstructor;
	}

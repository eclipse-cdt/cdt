...
public class ExecAliasDeclaration implements ICPPExecution {
	private final ICPPBinding declaredBinding;
	
	public ExecAliasDeclaration(ICPPBinding declaredBinding) {
	...
	public void marshal(ITypeMarshalBuffer buffer, boolean includeValue) throws CoreException {
		buffer.putShort(ITypeMarshalBuffer.EXEC_ALIAS_DECLARATION);

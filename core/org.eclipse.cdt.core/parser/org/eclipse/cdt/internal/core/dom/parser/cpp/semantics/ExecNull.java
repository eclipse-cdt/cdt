...
public class ExecNull implements ICPPExecution {
	@Override
	...
	@Override
	public ICPPExecution executeForFunctionCall(ActivationRecord record,
	...
	public void marshal(ITypeMarshalBuffer buffer, boolean includeValue) throws CoreException {
		buffer.putShort(ITypeMarshalBuffer.EXEC_NULL);
	}

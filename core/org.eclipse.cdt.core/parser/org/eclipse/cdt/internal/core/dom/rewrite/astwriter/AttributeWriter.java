...
public class AttributeWriter extends NodeWriter {
	...
	public void writeAttributeSpecifier(IASTAttributeSpecifier attribute) {
		...
		} else if (attribute instanceof IGNUASTAttributeSpecifier) {
			writeGNUAttributeSpecifier((IGNUASTAttributeSpecifier) attribute);
		}
	}

	private void writeGNUAttributeSpecifier(IGNUASTAttributeSpecifier specifier) {

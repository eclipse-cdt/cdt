...
public class NodeWriter {
	...
	protected void writeGNUAttributes(IASTAttributeOwner attributeOwner, EnumSet<SpaceLocation> spaceLocations) {
		IASTAttributeSpecifier[] specifiers = attributeOwner.getGNUAttributeSpecifiers();
		writeAttributes(specifiers, spaceLocations);
	}

	protected void writeCPPAttributes(IASTAttributeOwner attributeOwner, EnumSet<SpaceLocation> spaceLocations) {
		IASTAttributeSpecifier[] specifiers = attributeOwner.getCPPAttributeSpecifiers();
		writeAttributes(specifiers, spaceLocations);
	}

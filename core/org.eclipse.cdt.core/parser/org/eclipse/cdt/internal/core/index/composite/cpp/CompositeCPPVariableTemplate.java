	...
	public ICPPPartialSpecialization[] getPartialSpecializations() {
		try {
			...
			return ArrayUtil.addAll(
					ICPPVariableTemplatePartialSpecialization.EMPTY_PARTIAL_SPECIALIZATION_ARRAY,
					cf.getCompositeBindings(preresult));
		} catch (CoreException ce) {
			CCorePlugin.log(ce);
			return ICPPVariableTemplatePartialSpecialization.EMPTY_PARTIAL_SPECIALIZATION_ARRAY;
		}
	}

...
public abstract class InternalFileContentProvider extends IncludeFileContentProvider {
	 ...
	 * @param filePath the absolute location of the file.
	 * @param relevantMacros macros relevant to the file and their definitions.
	 * @param includeGuardMacro the name of the include guard macro for the file,
	 *     or <code>null</code> if the file doesn't have the include guard macro.
	 */
	public void reportTranslationUnitFile(String filePath, Map<String, String> relevantMacros,

...
public final class TypeMarshalBuffer implements ITypeMarshalBuffer {
	...
	public static final short NULL_TYPE       = 0x0000;
	public static final short INDIRECT_TYPE   = 0x001F;
	public static final short BINDING_TYPE    = 0x001E;
	public static final short UNSTORABLE_TYPE = 0x001D;
	...
	public ISerializableEvaluation unmarshalEvaluation() throws CoreException {
		int oldPos = fPos;
		short firstBytes = getShort();
		if (firstBytes == NULL_TYPE) {
			return null;
		}
		
		fPos = oldPos;  // fLinkage.unmarshalEvaluation() will read firstBytes again

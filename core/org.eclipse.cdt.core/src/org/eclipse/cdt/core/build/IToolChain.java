...
public interface IToolChain extends IAdaptable {
	...
	default boolean matches(Map<String, String> properties) {
		for (Map.Entry<String, String> property : properties.entrySet()) {
			String targetValue = getProperty(property.getKey());
			// If target doesn't have this property, it doesn't care
			if (targetValue != null && !property.getValue().equals(targetValue)) {
				return false;
			}
		}
		return true;

...
public class CodeFormatterApplication implements IApplication {
	...
	private final static class Messages extends NLS {
		private static final String BUNDLE_NAME = "org.eclipse.cdt.core.formatter.messages"; //$NON-NLS-1$
	...
	/**
	 * Checks if given file name ends with .c .cpp or .h
	 */
	private boolean hasSuitableFileExtension(File file) {
		String name = file.getName();
		return name.endsWith(".c") || name.endsWith(".cpp") || name.endsWith(".h"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}

...
//	public final static String FORMATTER_COMMENT_LINE_LENGTH = CCorePlugin.PLUGIN_ID + ".formatter.comment.line_length"; //$NON-NLS-1$
	 ...
	 *     - option id:         "org.eclipse.cdt.core.formatter.insert_new_line_after_label_in_labeled_statement"
	 *     - possible values:   { INSERT, DO_NOT_INSERT }
	 *     - default:           DO_NOT_INSERT
	 * </pre>
	 * @see CCorePlugin#INSERT
	 ...
	 * @since 5.12
	 */
	public static final String FORMATTER_INSERT_LINE_AFTER_LABEL_IN_LABELED_STATEMENT = CCorePlugin.PLUGIN_ID + ".formatter.insert_new_line_after_label_in_labeled_statement"; //$NON-NLS-1$
//	/**
//	 * <pre>

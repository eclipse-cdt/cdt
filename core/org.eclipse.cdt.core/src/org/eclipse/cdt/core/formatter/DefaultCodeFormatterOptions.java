...
//		options.put(DefaultCodeFormatterConstants.FORMATTER_COMMENT_LINE_LENGTH, Integer.toString(this.comment_line_length));
		...
		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_LABEL, this.insert_new_line_after_label? CCorePlugin.INSERT : CCorePlugin.DO_NOT_INSERT);		
...
//		}
		...
		final Object insertNewLineAfterLabel = settings.get(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_LABEL);
		if (insertNewLineAfterLabel != null) {
			this.insert_new_line_after_label = CCorePlugin.INSERT.equals(insertNewLineAfterLabel);
		}

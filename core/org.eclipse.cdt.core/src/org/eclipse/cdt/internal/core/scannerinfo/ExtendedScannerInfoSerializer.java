 ...
 * @see ShadowPattern
 */
public class ExtendedScannerInfoSerializer implements JsonSerializer<IExtendedScannerInfo> {
	@Override
	public JsonElement serialize(IExtendedScannerInfo info, Type typeOfInfo, JsonSerializationContext context) {

...
public class MakeErrorParser extends AbstractErrorParser {
	private static final ErrorPattern[] patterns = {
			...
			new ErrorPattern("(make.*missing separator \\(did you mean TAB instead of 8 spaces?\\).\\s*Stop.)", 1, //$NON-NLS-1$
			...
			new ErrorPattern("(make.*commands commence before first target.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*missing rule before commands.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*No rule to make target `.*', needed by `.*'.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*No targets specified and no makefile found.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*Included makefile `.*' was not found.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*warning: overriding commands for target `.*')", 1, //$NON-NLS-1$
			...
			new ErrorPattern("(make.*warning: ignoring old commands for target `.*')", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_WARNING) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*Circular .+ <- .+ dependency dropped.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*insufficient arguments to function `.*'.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*multiple target patterns.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*target pattern contains no `%'.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*mixed implicit and static pattern rules.\\s*Stop.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*warning: -jN forced in submake: disabling jobserver mode.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_WARNING) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*warning: jobserver unavailable: using -j1. Add `+' to parent make rule.)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_WARNING) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);
			...
			new ErrorPattern("(make.*target `.*' doesn't match the target pattern)", 1, //$NON-NLS-1$
					IMarkerGenerator.SEVERITY_ERROR_RESOURCE) {
				@Override
				protected boolean recordError(Matcher matcher, ErrorParserManager eoParser) {
					super.recordError(matcher, eoParser);

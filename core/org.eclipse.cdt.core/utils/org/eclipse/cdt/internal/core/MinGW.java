...
public class MinGW {
	...
	public static void changeMinGWDefaultLocation(String location) {
		...
		InstanceScope.INSTANCE.getNode(CCorePlugin.PLUGIN_ID).put(CCorePreferenceConstants.MINGW_LOCATION,
				location);
	}
	...
	public static ArrayList<String> getAllMinGWHome() {
		...
		minGWLocation = DefaultScope.INSTANCE.getNode(CCorePlugin.PLUGIN_ID)
				.get(CCorePreferenceConstants.MINGW_LOCATION, CCorePreferenceConstants.MINGW_LOCATION);
	...
	public static String getMSysHome() {
		if (mSysLocation != null && !mSysLocation.equals("")) //$NON-NLS-1$
			return mSysLocation;
		else
			return getAllMsysHomes().get(0);
	}
	...
	public static ArrayList<String> getAllMsysHomes() {
		...
		ArrayList<String> msysHomeValue = new ArrayList<>();

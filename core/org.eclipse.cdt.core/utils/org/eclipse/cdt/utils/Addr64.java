...
public class Addr64 implements IAddress, Serializable {
	...
	/**
	 * Create an address represented by long bits. Signed bit will be used, if you don't want it mask it
	 * before passing here.
	 * 
	 * @since 5.9
	 */
	public Addr64(long addr) {
		if (addr < 0)
			address = new BigInteger(ByteBuffer.allocate(8).putLong(addr).array());
		else

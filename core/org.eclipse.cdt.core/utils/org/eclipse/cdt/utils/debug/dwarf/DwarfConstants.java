...
public interface DwarfConstants {
	 ...
	 * @since 5.7
	 */
	int DW_FORM_GNU_addr_index = 0x1f01;
	/**
	 * @since 5.7
	 */
	int DW_FORM_GNU_str_index = 0x1f02;
	/* Extensions for DWZ multifile.
	   See http://www.dwarfstd.org/ShowIssue.php?issue=120604.1&type=open . */	
	/**
	 * @since 5.7
	 */
	int DW_FORM_GNU_ref_alt = 0x1f20;
	/**
	 * @since 5.7
	 */
	int DW_FORM_GNU_strp_alt = 0x1f21;
	 ...
	 * @since 5.7
	 */
	int DW_MACRO_define = 1;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_undef = 2;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_start_file = 3;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_end_file = 4;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_define_indirect = 5;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_undef_indirect = 6;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_transparent_include = 7;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_define_indirect_alt = 0x08;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_undef_indirect_alt = 0x09;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_transparent_include_alt = 0x0a;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_lo_user = 0xe0;
	/**
	 * @since 5.7
	 */
	int DW_MACRO_hi_user = 0xff;

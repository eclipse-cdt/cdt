...
public class CHelpProviderTester {
	...
	private class CHelpBook implements ICHelpBook {
		...
		public CHelpBook(String providerID, int type) throws IOException {
			fCHelpType = type;
	...
	private class CHelpResourceDescriptor implements ICHelpResourceDescriptor {
		...
		public CHelpResourceDescriptor(ICHelpBook helpBook, String string, String providerID) throws IOException {
			fBook = helpBook;
			fString = string;
	...
	private class FunctionSummary implements IFunctionSummary {
        ...
        public FunctionSummary(ICHelpBook helpBook, String string, String providerID) throws IOException {
        	fName = string;
	...
	private static String generateHelpString(ICHelpBook helpBook, String name, String providerID) throws IOException {
	...
	private static String generateBookTitle(String providerID, int bookType) throws IOException {
		Properties props = new Properties();
		props.setProperty(KEY_PROVIDER_ID, providerID);
	...
	public ICHelpBook[] generateCHelpBooks(final String providerID) throws IOException {

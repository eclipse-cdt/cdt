...
import org.eclipse.cdt.ui.tests.refactoring.rename.RenameRegressionTest;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ UtilTestSuite.class, RenameRegressionTest.class, ExtractFunctionRefactoringTest.class,

/*******************************************************************************
 * Copyright (c) 2008, 2018 Institute for Software, HSR Hochschule fuer Technik
...
public class MoveTypeRefactoringTest extends RefactoringTestBase {
	...
	protected CRefactoring createRefactoring() {
		return new MoveTypeRefactoring(getSelectedTranslationUnit(), getSelection(), getCProject());
	}

...
public class PullUpRefactoringTest extends RefactoringTestBase {
	...
	//};
	//#endif /* A_H_ */
	public void testPullUpMissingReference() throws Exception {
	...
	//};
	//#endif /* A_H_ */
	public void testPullUpFieldsFromSameDeclarations() throws Exception {
		this.selectTarget("Base");
		this.pullup("a", VisibilityEnum.v_public);
		this.pullup("b", VisibilityEnum.v_public);
		this.pullup("c", VisibilityEnum.v_public);
		this.assertRefactoringSuccess();
	}
	...
	//};
	//#endif /* A_H_ */
	public void testPullUpMultipleAttributesFromSameDeclaration() throws Exception {
		this.selectTarget("Base");
		this.pullup("b", VisibilityEnum.v_public);
		this.pullup("a", VisibilityEnum.v_public);
		this.assertRefactoringSuccess();
	...
	//};
	//#endif /* A_H_ */
	public void testDeclareVirtualSimpleFromDeclaration() throws Exception {
		this.selectTarget("Base");
		this.declareVirtual("myMethod", VisibilityEnum.v_protected);
		this.assertRefactoringSuccess();
	}

...
public class RenameRegressionTest extends RenameTestBase {
	public RenameRegressionTest() {
		super();
	}

	public RenameRegressionTest(String name) {
		super(name);
	}
	...
	public static Test suite(boolean cleanup) {
		TestSuite innerSuite = new TestSuite(RenameRegressionTest.class);
		innerSuite.addTest(new FailingTest(new RenameRegressionTest("_testMethod_35_72726"), 72726));

		TestSuite suite = new TestSuite("RenameRegressionTest");
		suite.addTest(innerSuite);
		suite.addTest(RenameVariableTest.suite(false));
		suite.addTest(RenameFunctionTest.suite(false));
		suite.addTest(RenameTypeTest.suite(false));
		suite.addTest(RenameMacroTest.suite(false));
		suite.addTest(RenameTemplatesTest.suite(false));

		if (cleanup)
			suite.addTest(new RenameRegressionTest("cleanupProject"));

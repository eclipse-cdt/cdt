 ...
 */
public class RenameVariableTest extends RenameTestBase {
	...
	public static Test suite(boolean cleanup) {
		TestSuite suite = new TestSuite(RenameVariableTest.class);

		if (cleanup) {
			suite.addTest(new RefactoringTest("cleanupProject"));
		}
		return suite;
	}

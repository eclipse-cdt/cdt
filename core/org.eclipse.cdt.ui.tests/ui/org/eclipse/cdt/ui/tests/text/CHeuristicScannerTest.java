...
public class CHeuristicScannerTest extends TestCase {
	...
	protected void setUp() {
		if (CCorePlugin.getDefault() != null) {
			...
			final String indentOnColumn = DefaultCodeFormatterConstants.createAlignmentValue(false,
					DefaultCodeFormatterConstants.WRAP_NO_SPLIT, DefaultCodeFormatterConstants.INDENT_ON_COLUMN);
	...
	public void testShiftOperator() throws Exception {
		fDocument.set("		for (int j = 0; j == 0; j ++) {\n" + "			j = 3 >> 1;\n");

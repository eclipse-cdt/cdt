...
public class CPartitionerTest extends TestCase {
	...
	public void testTogglePartition() {
		try {
			...
			result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation2 = { new TypedRegion(0, 6, ICPartitions.C_SINGLE_LINE_COMMENT),
	...
	public void testEditingCharacter() {
		try {
			...
			fDocument.replace(fDocument.getLength(), 0, "y");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 4, ICPartitions.C_CHARACTER),
					new TypedRegion(4, 1, IDocument.DEFAULT_CONTENT_TYPE) };
			checkPartitioning(expectation, result);
			...
			fDocument.replace(2, 0, "\\'");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 6, ICPartitions.C_CHARACTER),
					new TypedRegion(6, 1, IDocument.DEFAULT_CONTENT_TYPE) };
			checkPartitioning(expectation, result);
			...
			fDocument.replace(2, 2, "\\\r\n");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 7, ICPartitions.C_CHARACTER),
					new TypedRegion(7, 1, IDocument.DEFAULT_CONTENT_TYPE) };
			checkPartitioning(expectation, result);
	...
	public void testCommentInPreprocessorString() {
		try {
			...
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, fDocument.getLength(), ICPartitions.C_PREPROCESSOR) };
			checkPartitioning(expectation, result);
	...
	public void testString1() {
		try {
			...
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, fDocument.getLength(), ICPartitions.C_STRING) };
			checkPartitioning(expectation, result);

			fDocument.replace(0, fDocument.getLength(), "\"string1\" \"string2\"");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 9, ICPartitions.C_STRING),
	...
	public void testString2() {
		try {
			...
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, 8, ICPartitions.C_STRING),
	...
	public void testRawString1() {
		try {
			...
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, 1, IDocument.DEFAULT_CONTENT_TYPE),
					new TypedRegion(1, fDocument.getLength() - 1, ICPartitions.C_STRING) };
			checkPartitioning(expectation, result);

			fDocument.replace(0, fDocument.getLength(), "R\"()\"//comment");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 1, IDocument.DEFAULT_CONTENT_TYPE),
	...
	public void testRawString2() {
		try {
			...
			fDocument.replace(0, fDocument.getLength(),
					"#define X x\nR\"delimiter(line 1\n()delimitex\nline 3\n)delimiter\"");
			result = fDocument.computePartitioning(0, fDocument.getLength());
			expectation = new TypedRegion[] { new TypedRegion(0, 12, ICPartitions.C_PREPROCESSOR),
	...
	public void testRawString_Bug352544() {
		try {
			...
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, 3, IDocument.DEFAULT_CONTENT_TYPE),
					new TypedRegion(3, 3, ICPartitions.C_STRING),
					new TypedRegion(6, 1, IDocument.DEFAULT_CONTENT_TYPE), };
			checkPartitioning(expectation, result);
		} catch (BadLocationException x) {
	...
	public void testNumberSeparators() {
		try {
			fDocument.replace(0, fDocument.getLength(),
					"0b1'100'100'100\n1'123'456\n0x1000'1000\n0111'1000\n0xAABB'CCDD");
			ITypedRegion[] result = fDocument.computePartitioning(0, fDocument.getLength());
			TypedRegion[] expectation = { new TypedRegion(0, 59, IDocument.DEFAULT_CONTENT_TYPE) };
			checkPartitioning(expectation, result);
		} catch (BadLocationException x) {
			assertTrue(false);
		}

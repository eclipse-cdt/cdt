...
public class CPPParameterGuessingTest extends AbstractContentAssistTest {
	...
	public CPPParameterGuessingTest(String name) {
		super(name, true);
	}

	public static Test suite() {
		return BaseTestCase.suite(CPPParameterGuessingTest.class, "_");
	}

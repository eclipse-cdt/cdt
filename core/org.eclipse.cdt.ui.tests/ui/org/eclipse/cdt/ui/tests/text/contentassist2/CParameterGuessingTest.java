...
public class CParameterGuessingTest extends AbstractContentAssistTest {
	...
	public CParameterGuessingTest(String name) {
		super(name, false);
	}

	public static Test suite() {
		return BaseTestCase.suite(CParameterGuessingTest.class, "_");
	}

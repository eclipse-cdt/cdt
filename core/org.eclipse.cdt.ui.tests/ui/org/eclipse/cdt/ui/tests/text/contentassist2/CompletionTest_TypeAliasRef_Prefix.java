...
public class CompletionTest_TypeAliasRef_Prefix extends CompletionProposalsBaseTest {
	...
	private final String[] expectedResults = { "A_VisibleTypedef", "A_VisibleAlias" };
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(
				CompletionTest_TypeAliasRef_Prefix.class.getName());
		suite.addTest(new CompletionTest_TypeAliasRef_Prefix(
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.cdt.core.codeassist.tests.CompletionProposalsTest#
	 * getCompletionPosition()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.core.codeassist.tests.CompletionProposalsTest#getFileName
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.core.codeassist.tests.CompletionProposalsTest#getFileFullPath
	 * ()
	 */
	@Override

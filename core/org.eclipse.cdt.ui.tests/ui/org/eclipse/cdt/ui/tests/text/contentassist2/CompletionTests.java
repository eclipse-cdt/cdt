...
public class CompletionTests extends AbstractContentAssistTest {
	...
	private static void setDisplayDefaultArguments(boolean value) {
		...
		preferenceStore.setValue(ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_ARGUMENTS, value);
	}

	private static void setDisplayDefaultedParameters(boolean value) {
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS, value);
	}

...
public class ParameterHintTest extends AbstractContentAssistTest {
	...
	public ParameterHintTest(String name) {
		super(name, true);
	}

	public static Test suite() {
		return BaseTestCase.suite(ParameterHintTest.class, "_");
	}

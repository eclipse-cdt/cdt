...
public class DoxygenCCommentAutoEditStrategyTest extends AbstractAutoEditTest {
	...
	protected void setUp() throws Exception {
		...
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_BRIEF_TAG);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF,
				DocCommentOwnerManager.DEF_DOXYGEN_NEW_LINE_AFTER_BRIEF);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_PRE_POST_TAGS);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_JAVADOC_TAGS);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS,
	...
	public void testAutoDocCommentBrief() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, true);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentBriefNoNewLine() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF, false);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentStructured() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS, true);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentNoJavadoc() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS, false);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentPrePostTags() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS, true);
		assertAutoEditBehaviour();
	}

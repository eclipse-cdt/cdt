...
public class DoxygenCCommentAutoEditStrategyTest extends AbstractAutoEditTest {
	...
	protected void setUp() throws Exception {
		...
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, null,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_BRIEF_TAG);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF, null,
				DocCommentOwnerManager.DEF_DOXYGEN_NEW_LINE_AFTER_BRIEF);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS, null,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_PRE_POST_TAGS);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS, null,
				DocCommentOwnerManager.DEF_DOXYGEN_USE_JAVADOC_TAGS);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS, null,
	...
	public void testAutoDocCommentBrief() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, null, true);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentBriefNoNewLine() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, null, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF, null, false);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentStructured() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS, null, true);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentNoJavadoc() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, null, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS, null, false);
		assertAutoEditBehaviour();
	}
	...
	public void testAutoDocCommentPrePostTags() throws CoreException {
		DocCommentOwnerManager mng = DocCommentOwnerManager.getInstance();
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, null, true);
		mng.putBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS, null, true);
		assertAutoEditBehaviour();
	}

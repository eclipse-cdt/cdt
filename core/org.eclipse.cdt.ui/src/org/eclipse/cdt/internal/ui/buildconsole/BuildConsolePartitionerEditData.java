...
public class BuildConsolePartitionerEditData {
	...
	public interface UpdateUIData {
		 ...
		 */
		List<BuildConsoleStreamDecorator> getStreamsNeedingNotifcation();
	}
	 ...
	 */
	private Set<BuildConsoleStreamDecorator> fEditStreams = new HashSet<>();
	...
	public void append(String text, BuildConsoleStreamDecorator stream, ProblemMarkerInfo marker) {
	...
	public UpdateUIData getUpdate() {
		...
		return new UpdateUIData() {
			...
			@Override
			public List<BuildConsoleStreamDecorator> getStreamsNeedingNotifcation() {

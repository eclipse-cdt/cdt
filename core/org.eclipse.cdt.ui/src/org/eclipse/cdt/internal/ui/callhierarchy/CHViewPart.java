...
public class CHViewPart extends ViewPart {
	...
	private IBindingManagerListener bindingManagerListener = null;
			...
			bindingManagerListener = new IBindingManagerListener() {
				...
				public void bindingManagerChanged(BindingManagerEvent event) {
					if (event.isActiveBindingsChanged()) {
						...
						if (keyBinding != null) fRemoveFromViewAction.setText(CHMessages.CHViewPart_RemoveFromView_label + '\t'+ keyBinding);
					}
				}
			};

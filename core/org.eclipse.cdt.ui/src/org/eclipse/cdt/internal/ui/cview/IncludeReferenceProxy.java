...
public class IncludeReferenceProxy extends CElementGrouping {
	...
	public IncludeReferenceProxy getChild(String segment) {
		return children.computeIfAbsent(segment,
				unused -> new IncludeReferenceProxy(this, includeRefContainer, reference, segment));
	}
	...
	public IPath getPath() {
		// TODO probably should keep path when constructing segments?

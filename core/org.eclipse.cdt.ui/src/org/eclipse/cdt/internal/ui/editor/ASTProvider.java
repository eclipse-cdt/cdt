...
import org.eclipse.cdt.core.model.ITranslationUnitProvider;
...
public final class ASTProvider {
	...
	private class ActivationListener implements IPartListener2, IWindowListener {
		...
		private boolean isCEditor(IWorkbenchPartReference ref) {
			...
			if (part instanceof IEditorPart)
				return part.getAdapter(ITranslationUnitProvider.class) != null;
			return false;
		}
	}
	...
	private void activeEditorChanged(IWorkbenchPart editor) {
		...
		if (tu == null && editor != null) {
			ITranslationUnitProvider provider = (ITranslationUnitProvider) editor.getAdapter(ITranslationUnitProvider.class);
			if (provider != null)

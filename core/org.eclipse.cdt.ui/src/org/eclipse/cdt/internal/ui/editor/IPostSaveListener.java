 ...
 * <p>
 * This interface differs with JDT's {@code IPostSaveListener} in several aspects, CDT:
 * <ol>
 * <li>does not allow post-save listeners to make changes to the saved file</li>
 * <li>assumes that there can be more than one post-save listener</li>
 * <li>does not care about post-save listeners ordering, given that file changes are not allowed</li>
 * </ol>
 * </p>
 * 
 * @since 5.4

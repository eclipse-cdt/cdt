...
//		overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, ContentAssistPreference.TIMEOUT_DELAY));		
		...
		overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN, ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS));
		overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN, ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_ARGUMENTS));
...
//		addRadioButton(searchGroup, label, ContentAssistPreference.PROJECT_SEARCH_SCOPE, 0);
		...
		label = PreferencesMessages.CEditorPreferencePage_ContentAssistPage_displayDefaultedParameters;
		Button displayDefaultedParameters = addCheckBox(defaultArgumentsGroup, label,
				ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS, 0);
		...
		Button displayDefaultArguments = addCheckBox(defaultArgumentsGroup, label,
				ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_ARGUMENTS, 0);

		createDependency(displayDefaultedParameters,
				ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS, displayDefaultArguments);
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		store.setDefault(ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS, true);
		store.setDefault(ContentAssistPreference.DEFAULTARGUMENT_DISPLAY_ARGUMENTS, true);

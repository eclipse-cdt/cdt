...
public class NewLinesTabPage extends FormatterTabPage {
	...
	protected void doCreatePreferences(Composite composite, int numColumns) {
		...
		createPref(newlinesGroup, numColumns, FormatterMessages.NewLinesTabPage_newlines_group_option_after_label_in_labeled_statement, DefaultCodeFormatterConstants.FORMATTER_INSERT_LINE_AFTER_LABEL_IN_LABELED_STATEMENT, DO_NOT_INSERT_INSERT);		

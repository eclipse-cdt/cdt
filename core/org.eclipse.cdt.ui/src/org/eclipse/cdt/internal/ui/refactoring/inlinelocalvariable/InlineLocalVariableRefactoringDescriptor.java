...
public class InlineLocalVariableRefactoringDescriptor extends CRefactoringDescriptor {
	...
	public InlineLocalVariableRefactoringDescriptor(String project, String description,
			String comment, Map<String, String> arguments) {
		super(InlineLocalVariableRefactoring.ID, project, description, comment,
	...
	public CRefactoring createRefactoring(RefactoringStatus status) throws CoreException {
		...
		InlineLocalVariableRefactoring refactoring =
				new InlineLocalVariableRefactoring(getTranslationUnit(), selection, proj);

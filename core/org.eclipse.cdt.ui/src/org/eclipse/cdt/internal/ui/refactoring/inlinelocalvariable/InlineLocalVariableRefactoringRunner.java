...
public class InlineLocalVariableRefactoringRunner extends RefactoringRunner {
	...
	public InlineLocalVariableRefactoringRunner(ICElement element, ISelection selection, IShellProvider shellProvider,
			ICProject cProject) {
	...
	@Override
	public void run() {
		InlineLocalVariableRefactoring refactoring = new InlineLocalVariableRefactoring(element, selection, project);

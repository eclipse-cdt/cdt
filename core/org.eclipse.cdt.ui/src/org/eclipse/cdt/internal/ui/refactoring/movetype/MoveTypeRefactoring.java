...
public class MoveTypeRefactoring extends CRefactoring {
	...
	protected RefactoringDescriptor getRefactoringDescriptor() {
		...
		RefactoringDescriptor desc = new MoveTypeRefactoringDescriptor(project.getProject().getName(), "Move Type", //$NON-NLS-1$
				"Move " + target.getRawSignature(), arguments); //$NON-NLS-1$
		return desc;
	}

...
public class MoveTypeRefactoringDescriptor extends CRefactoringDescriptor {
	...
	public MoveTypeRefactoringDescriptor(String project, String description,
			String comment, Map<String, String> arguments) {
		super(MoveTypeRefactoring.ID, project, description, comment,
	...
	public CRefactoring createRefactoring(RefactoringStatus status) throws CoreException {
		...
		MoveTypeRefactoring refactoring =
				new MoveTypeRefactoring(getTranslationUnit(), selection, proj);

...
public class CodeParser {
	...
	public IASTNode parse(Method method) {
		...
		ICPPASTCompositeTypeSpecifier compTypeSpecifier = (ICPPASTCompositeTypeSpecifier) structDecl.getChildren()[0];
		IASTSimpleDeclaration simple = (IASTSimpleDeclaration) compTypeSpecifier.getMembers()[0].copy();
		simple.setParent(method.getDeclSpecifier());
		return simple;
	}
}

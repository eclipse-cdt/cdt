...
public class OverrideMethodsInputPage extends UserInputWizardPage {
	...
	public void createControl(Composite parent) {
		...
		ignoreVirtual.setText(Messages.OverrideMethodsRefactoring_IgnoreVirtual);
		ignoreVirtual.setSelection(fRefactoring.getOptions().ignoreVirtual());
		ignoreVirtual.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				fRefactoring.getOptions().setIgnoreVirtual(ignoreVirtual.getSelection());
			}
		});
		...
		link.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				String id = CodeStylePreferencePage.PREF_ID;

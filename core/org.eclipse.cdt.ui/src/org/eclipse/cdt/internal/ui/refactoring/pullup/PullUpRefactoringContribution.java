...
public class PullUpRefactoringContribution extends CRefactoringContribution {
	...
	public RefactoringDescriptor createDescriptor(String id, String project, String description,
		...
		if (id.equals(PullUpRefactoring.ID)) {
			return new PullUpRefactoringDescriptor(project, description, comment, 
					arguments);
		}
		return null;
	}

...
public class PullUpRefactoringDescriptor extends CRefactoringDescriptor {

	public PullUpRefactoringDescriptor(String project, String description,
			String comment, Map<String, String> arguments) {
		super(PullUpRefactoring.ID, project, description, comment, 
	...
	public CRefactoring createRefactoring(RefactoringStatus status) throws CoreException {
		final PullUpRefactoring refactoring = new PullUpRefactoring(this.getTranslationUnit(), 

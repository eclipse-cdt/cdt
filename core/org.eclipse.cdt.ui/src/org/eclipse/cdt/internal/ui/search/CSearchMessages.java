...
public final class CSearchMessages extends NLS {
	...
	public static String HideReadReferences_actionLabel;
	public static String HideReadReferences_description;
	public static String HideReadReferences_name;
	public static String HideWriteReferences_actionLabel;
	public static String HideWriteReferences_description;
	public static String HideWriteReferences_name;

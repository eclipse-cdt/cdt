...
public class CExpandHover extends AnnotationExpandHover {
	...
	protected Object getHoverInfoForLine(final ISourceViewer viewer, final int line) {
		/*
		 * TODO work out which of these is correct. 
		 * EDITOR_CORRECTION_INDICATION is initialised to different values in CDT & JDT with no UI to change
		 */

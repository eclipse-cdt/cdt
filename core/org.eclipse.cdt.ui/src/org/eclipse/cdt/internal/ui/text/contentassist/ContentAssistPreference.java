...
//	public final static String AUTOACTIVATION=  "content_assist_autoactivation";
	...
	public final static String DEFAULTARGUMENT_DISPLAY_DEFAULTED_PARAMETERS = "content_assist_defaultargument_display_defaulted_parameters"; //$NON-NLS-1$
	/** Preference key for display of default arguments in content assist  */
	public final static String DEFAULTARGUMENT_DISPLAY_ARGUMENTS = "content_assist_defaultargument_display_arguments"; //$NON-NLS-1$

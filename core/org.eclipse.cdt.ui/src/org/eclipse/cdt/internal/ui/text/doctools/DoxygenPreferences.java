...
public class DoxygenPreferences {
	...
	public DoxygenPreferences() {
		this(InstanceScope.INSTANCE.getNode(QUALIFIER).node(WORKSPACE_DOXYGEN_NODE));
	}

	public DoxygenPreferences(IProject project) {
		this.preferences = new ProjectScope(project).getNode(QUALIFIER).node(WORKSPACE_DOXYGEN_NODE);
	}

	private DoxygenPreferences(Preferences preferences) {

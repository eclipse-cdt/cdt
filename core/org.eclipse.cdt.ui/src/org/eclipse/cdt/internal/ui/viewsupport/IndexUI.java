...
public class IndexUI {
	...
	public static String getFileNotIndexedMessage(ICElement input) {
		...
		if (res != null) {
			...
			if (props == null || !Boolean.parseBoolean(props.get(IndexerPreferences.KEY_INDEX_ALL_FILES)) ||
					(!Boolean.parseBoolean(props.get(IndexerPreferences.KEY_INDEX_UNUSED_HEADERS_WITH_DEFAULT_LANG)) &&
					 !Boolean.parseBoolean(props.get(IndexerPreferences.KEY_INDEX_UNUSED_HEADERS_WITH_ALTERNATE_LANG)))) {

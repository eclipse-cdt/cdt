...
public class DocCommentOwnerComposite extends Composite {
	...
	//FIXME: should be encapsulated with DoxygenPreferences
	...
	public DocCommentOwnerComposite(Composite parent, IDocCommentOwner initialOwner, String description, String label) {
		...
		createCheckBox(group, DialogsMessages.DocCommentOwnerComposite_UseTagJavadocStyleTitle, DOXYGEN_USE_JAVADOC_TAGS,
				DEF_DOXYGEN_USE_JAVADOC_TAGS);

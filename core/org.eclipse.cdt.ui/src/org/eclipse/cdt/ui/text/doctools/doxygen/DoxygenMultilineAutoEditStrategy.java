...
public class DoxygenMultilineAutoEditStrategy extends DefaultMultilineCommentAutoEditStrategy
	...
	private void refreshPreferences() {
		...
		if (project == null) {
			newLineAfterBrief = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF,
					DocCommentOwnerManager.DEF_DOXYGEN_NEW_LINE_AFTER_BRIEF);
			useBriefTag = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_BRIEF_TAG);
			useJavadocStyle = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_JAVADOC_TAGS);
			usePrePostTag = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_PRE_POST_TAGS);
			useStructuralCommands = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_STRUCTURED_COMMANDS);
		} else {
			newLineAfterBrief = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_NEW_LINE_AFTER_BRIEF, project,
					DocCommentOwnerManager.DEF_DOXYGEN_NEW_LINE_AFTER_BRIEF);
			useBriefTag = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_BRIEF_TAG, project,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_BRIEF_TAG);
			useJavadocStyle = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_JAVADOC_TAGS, project,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_JAVADOC_TAGS);
			usePrePostTag = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_PRE_POST_TAGS, project,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_PRE_POST_TAGS);
			useStructuralCommands = mng.getBooleanPref(DocCommentOwnerManager.DOXYGEN_USE_STRUCTURAL_COMMANDS, project,
					DocCommentOwnerManager.DEF_DOXYGEN_USE_STRUCTURED_COMMANDS);
		}
	}

...
/**
 * A source container that maps some file system locations to other files System
 * locations, using the debugger backend to perform the substitutions. By the
 * backend debugger performing the source lookup, it allows CDT to be simply
 * presented with the source paths as they are on the users machine.
 * 
 * @since 7.8
 */

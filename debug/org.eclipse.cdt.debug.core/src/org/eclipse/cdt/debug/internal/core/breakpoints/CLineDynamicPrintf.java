...
/**
 * A DynamicPrintf that collects data when a particular line of code is reached.
 *
 * @since 7.3
 */
public class CLineDynamicPrintf extends AbstractDynamicPrintf implements ICDynamicPrintf, ICLineBreakpoint2 {
	...
	protected String getMarkerMessage() throws CoreException {
		return MessageFormat.format( BreakpointMessages.getString( "CLineDynamicPrintf.0" ), (Object[])new String[] { "\"" + getPrintfString() + "\""} ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}

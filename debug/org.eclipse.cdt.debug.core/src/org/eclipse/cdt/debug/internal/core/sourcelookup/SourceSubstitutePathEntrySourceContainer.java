...
public class SourceSubstitutePathEntrySourceContainer extends MapEntrySourceContainer
	...
	public static final String TYPE_ID = CDebugCorePlugin.getUniqueIdentifier()
			+ ".containerType.sourceSubstitutePathEntry"; //$NON-NLS-1$
	...
	public Object[] findSourceElements(String name) throws CoreException {
		/*
		 * This class has delegated the actually source lookup to the debugger
		 * back end. Therefore this source lookup contributor does not find any
		 * files itself. This is because once the back end substitution has been
		 * done, there is nothing else for this contributor to add. Generally
		 * the Absolute File Path will now resolve the name to a source element.
		 */
		return new Object[0];
	}

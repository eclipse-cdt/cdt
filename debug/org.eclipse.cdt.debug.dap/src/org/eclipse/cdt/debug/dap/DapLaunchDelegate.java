	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor)
		...
		try {
			URL fileURL = FileLocator.toFileURL(
					getClass().getResource("/debug-servers/node_modules/cdt-gdb-adapter/dist/debugAdapter.js")); //$NON-NLS-1$
			String path = fileURL.getPath();
			//		String path = "/scratch/eclipse/src/cdt/org.eclipse.cdt/dap/org.eclipse.cdt.debug.dap/debug-servers/node_modules/cdt-gdb-adapter/dist/debugAdapter.js";

 ...
 *
 */
public class MiCoreDebugOptions implements DebugOptionsListener{

	private static final String DEBUG_FLAG = "org.eclipse.cdt.debug.mi.core/debug"; //$NON-NLS-1$
	 ...
	 * Constructor
	 */
	public MiCoreDebugOptions(BundleContext context) {
		Hashtable<String, String> props = new Hashtable<String, String>(2);
		props.put(org.eclipse.osgi.service.debug.DebugOptions.LISTENER_SYMBOLICNAME, MIPlugin.getUniqueIdentifier());
	...
	public void optionsChanged(DebugOptions options) {
		fgDebugTrace = options.newDebugTrace(MIPlugin.getUniqueIdentifier());

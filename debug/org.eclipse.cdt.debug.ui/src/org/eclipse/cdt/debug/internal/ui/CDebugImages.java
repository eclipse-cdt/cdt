...
public class CDebugImages {
	...
	public static final String IMG_OBJS_HWBREAKPOINT_ENABLED = NAME_PREFIX + "hwbrkp_obj.png";	//$NON-NLS-1$
	public static final String IMG_OBJS_HWBREAKPOINT_DISABLED = NAME_PREFIX + "hwbrkpd_obj.png";	//$NON-NLS-1$

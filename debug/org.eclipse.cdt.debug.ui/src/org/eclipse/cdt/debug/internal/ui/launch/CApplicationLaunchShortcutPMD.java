/*******************************************************************************
 * Copyright (c) 2013 BlackBerry Ltd and others.
...
public class CApplicationLaunchShortcutPMD extends CApplicationLaunchShortcut {
	...
	protected ILaunchConfiguration findLaunchConfiguration(IBinary bin, String mode) {
		...
		IResource resource = (IResource) bin.getAdapter(IResource.class);
		if (resource instanceof IFile) {
			try {
				ILaunchConfigurationWorkingCopy wc = lc.getWorkingCopy();
				// set the core file path, for now, it is for core file only. Trace file is not supported.
				wc.setAttribute(

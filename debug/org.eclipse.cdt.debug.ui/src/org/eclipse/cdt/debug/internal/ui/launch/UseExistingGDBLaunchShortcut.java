...
public class UseExistingGDBLaunchShortcut implements ILaunchShortcut2 {
	
	final String BINARYLESS_DEBUG_LAUNCH_NAME = "Reuse existing GDB session Launch"; //$NON-NLS-1$
	...
	private ILaunchConfiguration createConfiguration(String mode) {
		...
		try {
			...
			wc.setAttribute(ICDTLaunchConfigurationConstants.ATTR_DEBUGGER_START_MODE,
					ICDTLaunchConfigurationConstants.DEBUGGER_MODE_WHATEVER);

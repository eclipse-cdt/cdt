...
public class NewSourceSubstitutePathSourceContainerBrowser extends AbstractSourceContainerBrowser {
	private static final String NEW_SOURCE_SUB_MESSAGE = SourceLookupUIMessages.SourceSubstitutePathSourceContainerBrowser_0;

	@Override
	public ISourceContainer[] addSourceContainers(Shell shell, ISourceLookupDirector director) {
		SourceSubstitutePathSourceContainerDialog dialog = new SourceSubstitutePathSourceContainerDialog(shell,

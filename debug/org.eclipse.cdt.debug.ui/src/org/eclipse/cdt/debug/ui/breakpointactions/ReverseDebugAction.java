...
public class ReverseDebugAction extends AbstractBreakpointAction{
	 ...
	 */
	public static enum REVERSE_DEBUG_ACTIONS_ENUM { ENABLE, DISABLE, TOGGLE };
	...
	public String getSummary() {
		return fOperation.toString().toLowerCase() + " " + Messages.getString("ReverseDebugAction.Summary"); //$NON-NLS-1$ //$NON-NLS-2$
	}

...
public class ReverseDebugActionComposite  extends Composite {
	...
	public ReverseDebugActionComposite(Composite parent, int style, ReverseDebugActionPage page) {
		...
		combo.add(Messages.getString("ReverseDebugAction.enable")); //$NON-NLS-1$
		combo.add(Messages.getString("ReverseDebugAction.disable")); //$NON-NLS-1$
		combo.add(Messages.getString("ReverseDebugAction.toggle")); //$NON-NLS-1$
		combo.select(0);
	}

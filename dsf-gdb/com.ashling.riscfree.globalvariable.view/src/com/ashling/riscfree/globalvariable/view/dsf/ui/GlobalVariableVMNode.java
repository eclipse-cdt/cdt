...
public class GlobalVariableVMNode extends AbstractExpressionVMNode
	...
	private void getLocalsUpdateElementsInSessionThread(final IChildrenUpdate update) {
		...
		if (frameDmc == null || expressionService == null || context == null) {
			handleFailedUpdate(update);
			return;
		}

		final IGlobalVariableService gobalService = getServicesTracker().getService(IGlobalVariableService.class);
		...
		gobalService.getGlobals(frameDmc, rm);
	}

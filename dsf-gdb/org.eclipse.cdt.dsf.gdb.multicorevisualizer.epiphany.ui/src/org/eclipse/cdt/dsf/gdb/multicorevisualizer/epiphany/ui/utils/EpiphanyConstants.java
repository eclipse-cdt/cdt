...
//	static final int[] ECORE_BOUNDS = {	0, 0, 3, 3 };
	...
	/**  */
	public static final Color EV_COLOR_LOW_LOAD_BG = Colors.GREEN;
	/**  */
	public static final Color EV_COLOR_MED_LOAD_BG = Colors.YELLOW;
	/**  */
	public static final Color EV_COLOR_HIGH_LOAD_BG = Colors.RED;
	/**  */
	public static final Color EV_COLOR_LOW_LOAD_FG = Colors.DARK_GREEN;
	/**  */
	public static final Color EV_COLOR_MED_LOAD_FG = Colors.ORANGE;
	/**  */
	public static final Color EV_COLOR_HIGH_LOAD_FG = Colors.DARK_RED;

...
public class EpiphanyVisualizerCanvas extends MulticoreVisualizerCanvas implements ISelectionProvider 
{
	...
	protected void createGraphicalObjects() {
		...
		m_epiphanyChip.setVirtualBounds(m_eConstants.getEpiphanyChipBounds());
...
//			}
	...
	public void paintCanvas(GC gc) {
		...
		// paint objects
		m_epiphanyChip.paint(gc, false);
		// paint decorations
		m_epiphanyChip.paint(gc, true);
		// paint marquee
...
//		m_epiphanyChip.drawGrid(gc);
	...
	{
		List<VirtualBoundsGraphicObject> selectedObjects = new ArrayList<VirtualBoundsGraphicObject>();
		List<VirtualBoundsGraphicObject> selectableObjects =  m_epiphanyChip.getSelectableObjects();
		...
		// one we want.
		for (VirtualBoundsGraphicObject gobj : selectableObjects) {
...
//	@Override
//	protected List<GraphicObject> getSelectableObjects () {

...
/** Actions that shows/hides the debug part of the Multicore Visualizer toolbar */
public class ShowDebugToolbarAction extends VisualizerAction {
	...
	public ShowDebugToolbarAction(boolean showDebugActions, String MVInstanceId)
	{
		...
		m_persistentSettingsManager = 
				new PersistentSettingsManager(MulticoreVisualizerUIPlugin.PLUGIN_ID, MVInstanceId);

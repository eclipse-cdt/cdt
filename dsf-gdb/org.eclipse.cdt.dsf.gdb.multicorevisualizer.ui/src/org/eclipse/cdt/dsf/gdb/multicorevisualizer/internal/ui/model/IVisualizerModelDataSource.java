...
import org.eclipse.cdt.dsf.gdb.multicorevisualizer.internal.ui.model.IDisposable;
...
public interface IVisualizerModelDataSource extends IDisposable {
       ...
       /** Disposes the data source, including all listeners and any held resource */
       @Override
       public void dispose();

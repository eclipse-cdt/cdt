...
public class MulticoreVisualizer extends GraphicCanvasVisualizer implements IPinnable {
	...
	protected PersistentParameter<Boolean> m_loadMetersEnabled;
	...
	protected PersistentParameter<Integer> m_loadMeterTimerPeriod;
	...
	protected void initializePersistentParameters() {
		// setting managers
		m_persistentSettingsManager = new PersistentSettingsManager(m_visualizerInstanceId);

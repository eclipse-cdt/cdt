...
public class MulticoreVisualizerCPU extends MulticoreVisualizerGraphicObject
{
	 ...
	 * @since 1.1
	 */
	public static final Color BG_COLOR = IMulticoreVisualizerConstants.COLOR_CPU_BG;
	
	/**
	 * @since 1.1
	 */
	public static final Color FG_COLOR = IMulticoreVisualizerConstants.COLOR_CPU_FG;

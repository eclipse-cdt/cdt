			...
			if (m_model != null) {
				...
				while (modelCpus.hasMoreElements()) {
					...
					if(meter != null) {
						...
						// create new meter
						visualizerCpu.setLoadMeter(new MulticoreVisualizerLoadMeter(modelCpu.getLoad(), modelCpu.getHighLoadWatermark()));
					}
					...
					for (VisualizerCore modelCore : modelCpu.getCores()) {
						...
						if(meter != null) {
							...
							visualizerCore.setLoadMeter(new MulticoreVisualizerLoadMeter(modelCore.getLoad(), modelCore.getHighLoadWatermark()));
						}
					}
				}
			}

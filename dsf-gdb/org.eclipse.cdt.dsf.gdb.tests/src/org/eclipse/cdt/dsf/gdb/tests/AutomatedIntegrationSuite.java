...
import org.eclipse.cdt.dsf.mi.service.command.output.MIStringHandlerTest;
import org.eclipse.cdt.dsf.mi.service.command.output.MIThreadTest;
...
@SuiteClasses({ MIThreadTest.class, TestMIBreakInsertCommand.class, TestMICommandConstructCommand.class,
		TestMIGDBSetSysroot.class, LaunchUtilsTest.class, MIStringHandlerTest.class, ProcStatParserTest.class,

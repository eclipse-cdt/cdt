...
public class PersistentSettingsManagerTest {
	...
	public void testUnsupportedMapType() throws Exception {
		PersistentMapParameter<Float> persistentFloatMap = m_persistentSettingsManager1.getNewMapParameter(Float.class, "Map of Float Parameter", false, new HashMap<String,Float>());
	}

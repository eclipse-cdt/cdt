...
import org.eclipse.cdt.dsf.gdb.internal.ui.actions.DsfMultiTerminateCommand;
import org.eclipse.cdt.dsf.gdb.internal.ui.actions.GdbMultiDisconnectCommand;
    ...
    implements IAdapterFactory, ILaunchesListener2
{
    ...
    class SessionAdapterSet {
        ...
        SessionAdapterSet(GdbLaunch launch) {
            ...
            fTerminateCommand = new DsfMultiTerminateCommand(session);
            ...
            fDisconnectCommand = new GdbMultiDisconnectCommand(session);

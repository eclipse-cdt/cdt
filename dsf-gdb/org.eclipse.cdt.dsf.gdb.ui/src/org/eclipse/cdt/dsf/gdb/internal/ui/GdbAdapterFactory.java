    ...
    implements IAdapterFactory, ILaunchesListener2
{
     ...
     * </p>
     */
    private static Map<ILaunch, GdbSessionAdapters> fgDisposedLaunchAdapterSets =
        new WeakHashMap<ILaunch, GdbSessionAdapters>();
    ...
    public Object getAdapter(Object adaptableObject, Class adapterType) {
        ...
        if (adapterType.equals(IElementContentProvider.class)) return adapterSet.getViewModelAdapter();
        else if (adapterType.equals(IModelProxyFactory.class)) return adapterSet.getViewModelAdapter();
        else if (adapterType.equals(IColumnPresentationFactory.class)) return adapterSet.getViewModelAdapter();
        else if (adapterType.equals(ISuspendTrigger.class)) return adapterSet.getSuspendTrigger();
        else return null;
    }

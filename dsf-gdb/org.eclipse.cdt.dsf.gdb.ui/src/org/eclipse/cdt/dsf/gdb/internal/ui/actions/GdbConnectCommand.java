...
public class GdbConnectCommand implements IConnect {
     ...
     * <p>
     * In case the provided processPath has an absolute path, and the path to the file is a valid one on the local machine, 
     * It populates the fProcessNameToBinaryMap map with it.
     * <p>
     * In case the provided processPath has a relative path, iterates over sharedLib paths from UI and 
     * appends the path to it while founds a valid one. Populates the found path to fSupposedProcessNameToBinaryMap.
     *  

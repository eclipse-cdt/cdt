...
public class GdbReverseToggleCommand extends AbstractDebugCommand implements IChangeReverseMethodHandler {
    ...
    private IReverseTraceMethod fTraceMethod = ReverseTraceMethod.STOP_TRACE;
    ...
    @Override
    public void setTraceMethod(IReverseTraceMethod traceMethod) {
        fTraceMethod = traceMethod;
    }

    @Override
    public IReverseTraceMethod getTraceMethod(final Object context) {
        IDMContext dmc;
        ...
        Query<IReverseTraceMethod> ReverseMethodQuery = new Query<IReverseTraceMethod>() {
        @Override
            public void execute(final DataRequestMonitor<IReverseTraceMethod> rm) {
                final IReverseRunControl2 runControl = fTracker.getService(IReverseRunControl2.class);
                if (runControl != null) {
            ...
            try {
                ...
                IReverseTraceMethod returnedTrace =  ReverseMethodQuery.get();

...
public class GdbFullCliConsolePage extends Page implements IDebugContextListener {
	...
	private GdbAutoTerminateAction fAtutoTerminateAction;
		...
		fConsolePropertyChangeListener = new IPropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				if (event.getProperty().equals(IGdbDebugPreferenceConstants.PREF_AUTO_TERMINATE_GDB)) {
					...
					Boolean terminate = terminateStr.equals(Boolean.FALSE.toString()) ? Boolean.FALSE : Boolean.TRUE;
					fAtutoTerminateAction.setChecked(terminate);
				}
			}
		};
	...
	protected void createActions() {
		...
		fAtutoTerminateAction = new GdbAutoTerminateAction();
	}
	...
	protected void contextMenuAboutToShow(IMenuManager menuManager) {
		...
		menuManager.add(fAtutoTerminateAction);
	}

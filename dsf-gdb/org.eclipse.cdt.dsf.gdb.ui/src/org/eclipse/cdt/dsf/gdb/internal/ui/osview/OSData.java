...
{
	public OSData(String resourceClass, IGDBHardwareAndOS.IResourcesInformation data) {
		this.data = data;
	...
	private IGDBHardwareAndOS.IResourcesInformation data;

...
public class SessionOSData {
	...
	public SessionOSData(DsfSession session, final ICommandControlDMContext executionContext)
	{
		...
		executor.submit(new DsfRunnable() {
			...
			public void run() {
				...
				fHardwareOs.getResourceClasses(executionContext, new DataRequestMonitor<IGDBHardwareAndOS2.IResourceClass[]>(fSession.getExecutor(), null) {
					@Override
	...
	private void installEventHandler(final ICommandControlDMContext executionContext)
	{		

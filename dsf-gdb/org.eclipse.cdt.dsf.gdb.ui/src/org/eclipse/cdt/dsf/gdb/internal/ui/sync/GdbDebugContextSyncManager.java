 ...
 */
public class GdbDebugContextSyncManager implements IDebugSelectionSyncManager {

	/* (non-Javadoc)
	 * @see org.eclipse.cdt.dsf.gdb.internal.ui.sync.IDebugSelectionSyncManager#startup()
	 */
	@Override
	public void startup() {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.cdt.dsf.gdb.internal.ui.sync.IDebugSelectionSyncManager#shutdown()
	 */
	@Override
			...
			if (dmc instanceof IMIExecutionDMContext || dmc instanceof IFrameDMContext) {
				...
				session.getExecutor().execute(new Runnable() {
					...
					public void run() {
						...
						if (gdbSync != null) {
							gdbSync.setFocus(new IDMContext[] {dmc});
						}

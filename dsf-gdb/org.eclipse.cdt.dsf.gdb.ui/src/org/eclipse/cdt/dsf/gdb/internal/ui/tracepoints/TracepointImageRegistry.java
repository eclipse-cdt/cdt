...
public class TracepointImageRegistry extends AbstractImageRegistry {
    ...
    public static final String ICON_Circular_Buffer = add(ORG_ECLIPSE_CDT_DSF_GDB_UI_PLUGIN_ID, new String[] {"full/view16"}, "circular_buffer3.png"); //$NON-NLS-1$ //$NON-NLS-2$

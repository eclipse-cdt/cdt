...
//    		final IDMEvent<?> dmEvent = (IDMEvent<?>)event;
//    		Object elem = parentDelta.getElement();
//    		// we only have processes nodes under the GDB node when 
//			// groups are not present
//    		if (elem instanceof GdbLaunch) {
//    			try {
//    				getSession().getExecutor().execute(new Runnable() { 
//    					@Override public void run() {
//    						DataRequestMonitor<Boolean> myRm = new DataRequestMonitor<Boolean>(getExecutor(), rm) {
//    							@Override
//    							public void handleCompleted() {
//    								if (isSuccess()) {
//    									boolean groups = getData();
//    									// no groups - permit Container under gdbLaunch
//    									if (!groups) {
//    										IDMContext dmc = DMContexts.getAncestorOfType(dmEvent.getDMContext(), IContainerDMContext.class);
//    										if (dmc != null) {
//    											rm.done(new IVMContext[] { createVMContext(dmc) });
//    											return;
//    										}
//    									}
//    									else {
...
//    	Boolean groups = new Boolean(false);
//    	rm.done(groups);
//    }
...
//    		IDMContext dmc = DMContexts.getAncestorOfType(dmEvent.getDMContext(), IProcessDMContext.class);
//    		if (dmc != null) {

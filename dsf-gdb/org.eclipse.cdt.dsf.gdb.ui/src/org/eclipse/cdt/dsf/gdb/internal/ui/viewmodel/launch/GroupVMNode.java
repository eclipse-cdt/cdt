...
//    					else if (event instanceof IContainerResumedDMEvent) {
//    						IContainerResumedDMEvent e = (IContainerResumedDMEvent) event;
//    						if (e.getTriggeringContexts().length > 0) {
//    							eventCtx = e.getTriggeringContexts()[0];
//    						}
//    						else {
...
//    					}
    					...
    					if (tracker != null) {
    						...
    						// 
    						groupingService.getGroups(execCtx,

...
public interface IGdbDebugPreferenceConstants {
	...
	/**
	 * The maximum number of lines a single message can be. Default is IGdbDebugPreferenceConstants.MAX_MI_OUTPUT_LINES_DEFAULT.
	 * @since 5.5
	 */
	 ...
	 */
	public static final int MAX_MI_OUTPUT_LINES_DEFAULT = 10;

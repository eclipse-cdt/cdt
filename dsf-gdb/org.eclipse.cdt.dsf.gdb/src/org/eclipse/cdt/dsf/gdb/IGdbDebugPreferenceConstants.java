...
public interface IGdbDebugPreferenceConstants {
	 ...
	 * @since 4.0
	 */
	String PREF_ENABLE_PRETTY_PRINTING = "enablePrettyPrinting"; //$NON-NLS-1$
	 ...
	 * @since 4.0
	 */
	String PREF_INITIAL_CHILD_COUNT_LIMIT_FOR_COLLECTIONS = "initialChildCountLimitForCollections"; //$NON-NLS-1$
	
	/**
	 * The default command for gdb
	 * @since 4.0
	 */
	String PREF_DEFAULT_GDB_COMMAND = "defaultGdbCommand"; //$NON-NLS-1$
	
	/**
	 * The default command file for gdb
	 * @since 4.0
	 */
	String PREF_DEFAULT_GDB_INIT = "defaultGdbInit"; //$NON-NLS-1$

	/**
	 * The value is a boolean specifying the default for whether to stop at main().
	 * @since 4.0
	 */
	String PREF_DEFAULT_STOP_AT_MAIN = "defaultStopAtMain"; //$NON-NLS-1$

	/**
	 * The value is a string specifying the default symbol to use for the main breakpoint.
	 * @since 4.0
	 */
	String PREF_DEFAULT_STOP_AT_MAIN_SYMBOL = "defaultStopAtMainSymbol"; //$NON-NLS-1$

	/**
	 * The value is a boolean specifying the default for the non-stop debugger mode.
	 * @since 4.0
	 */
	String PREF_DEFAULT_NON_STOP = "defaultNonStop"; //$NON-NLS-1$

	/**
	 * The value is an boolean specifying whether the timeout is used for GDB commands.
	 * @since 4.1
	 */
	String PREF_COMMAND_TIMEOUT = PREFIX + "commandTimeout"; //$NON-NLS-1$

	/**
	 * The value is an integer specifying the timeout value (milliseconds) for GDB commands.
	 * @since 4.1
	 */
	String PREF_COMMAND_TIMEOUT_VALUE = PREFIX + "commandTimeoutValue"; //$NON-NLS-1$

	/**
	 * The value is a string specifying the list of GDB/MI commands with custom timeout values.
	 * @since 4.1
	 */
	String PREF_COMMAND_CUSTOM_TIMEOUTS = PREFIX + "commandCustomTimeouts"; //$NON-NLS-1$

	/**
	 * Default default value for <code>PREF_COMMAND_TIMEOUT</code>;
	 * @since 4.1
	 */
	int COMMAND_TIMEOUT_VALUE_DEFAULT = 10000;
	 ...
	 * @since 4.1
	 */
	String PREF_USE_RTTI = PREFIX + "useRtti"; //$NON-NLS-1$
	 ...
	 * @since 4.1
	 */
	String PREF_HIDE_RUNNING_THREADS = PREFIX + "hideRunningThreads"; //$NON-NLS-1$
	 ...
	 * @since 4.2
	 */
	String PREF_AGGRESSIVE_BP_FILTER = PREFIX + "aggressiveBpFilter"; //$NON-NLS-1$
}

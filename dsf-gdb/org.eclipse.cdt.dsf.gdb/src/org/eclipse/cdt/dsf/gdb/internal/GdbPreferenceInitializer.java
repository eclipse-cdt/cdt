...
public class GdbPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		node.putBoolean(IGdbDebugPreferenceConstants.PREF_MAX_MI_OUTPUT_LINES_ENABLE, true);
		node.putInt(IGdbDebugPreferenceConstants.PREF_MAX_MI_OUTPUT_LINES, IGdbDebugPreferenceConstants.MAX_MI_OUTPUT_LINES_DEFAULT);

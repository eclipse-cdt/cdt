...
public class GdbMemoryBlock extends DsfMemoryBlock implements IMemorySpaceAwareMemoryBlock {
    ...
    public void eventDispatched(IMemoryChangedEvent e) {
    	//TODO: Check
    	//Not sure why this block is not built with an IMemorySpaceDMContext
    	//The following normalization to IMemorySpaceDMContext is seen as temporary work around

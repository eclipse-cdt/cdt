...
public interface IMIExecutionContextTranslator extends IExecutionContextTranslator {
     ...
     */
	IContainerDMContext createContainerPath(IContainerDMContext containerDmc, IMIExecutionDMContext threadDmc);
     ...
     */
    IDMContext getStableContext(IExecutionDMContext executionDMContext);
     ...
     */
	void getExecutionAndContainerContexts(IContainerDMContext containerDmc, DataRequestMonitor<IExecutionDMContext[]> rm);
}

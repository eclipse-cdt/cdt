...
public interface IMIExecutionContextTranslator extends IExecutionContextTranslator{
     ...
     */
	public IContainerDMContext createContainerPath(IContainerDMContext containerDmc, IThreadDMContext threadDmc);
     ...
     * @return true if the containerDmc contains thread execution contexts.
     */

...
public class GDBSynchronizer extends AbstractDsfService implements IGDBSynchronizer, IEventListener
{
	...
	private void doInitialize(RequestMonitor requestMonitor) {
		...
		// in invalid initial contexts. This will self-correct,  when a first selection is 
		// made in the DV, for that session.
     ...
     */
	public static void setSyncEnabled(boolean enable) {
		fSyncEnabled = enable;
	}

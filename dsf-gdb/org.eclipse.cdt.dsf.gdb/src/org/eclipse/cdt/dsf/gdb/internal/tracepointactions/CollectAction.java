...
public class CollectAction extends AbstractTracepointAction {
	...
	public String getMemento() {
		...
		try {
			...
			rootElement.setAttribute(COLLECT_AS_STRING_LIMIT_ATTR, fCharPtrAsStringsLimit.toString());
	...
	public String getSummary() {
		...
		StringBuffer collectCmd = new StringBuffer();
		...
		return MessageFormat.format(MessagesForTracepointActions.TracepointActions_Collect_text, new Object[] { collectCmd.toString() });
	}

...
public class FinalLaunchSequence_7_5 extends FinalLaunchSequence_7_2 {
	...
	public void stepSetDPrinfStyle(final RequestMonitor rm) {
		...
		// make the dynamic-printf appear along with normal printfs
		// in the eclipse process console.
		String style = "call";  //$NON-NLS-1$
		if (fBackend.getSessionType() == SessionType.REMOTE) {
			// For remote sessions we use the 'agent' style which will
			// make the dynamic-printf appear along with normal printfs
			// outside of eclipse, where the program does its printfs.
			style = "agent";  //$NON-NLS-1$
		}

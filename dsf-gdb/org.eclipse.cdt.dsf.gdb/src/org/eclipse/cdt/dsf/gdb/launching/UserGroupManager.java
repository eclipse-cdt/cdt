...
import org.eclipse.cdt.dsf.gdb.launching.GdbGrouping.MIUserGroupDMC;
...
//		}		
	...
	public UserGroupManager(DsfSession session, DsfServicesTracker tracker) {
	    fSession = session;
	...
	protected void canGroup(IExecutionDMContext[] contexts,  DataRequestMonitor<Boolean> rm) {
		rm.done(doCanGroup(contexts));
	}
	
	protected void canUngroup(IExecutionDMContext[] contexts, DataRequestMonitor<Boolean> rm) {
	 ...
	 */
	public void group(IExecutionDMContext[] contexts, DataRequestMonitor<IGroupDMContext> rm) {

...
public class GDBMemory extends MIMemory implements IGDBMemory {
	...
	@Override
	public void initializeMemoryData(IContainerDMContext ctx, RequestMonitor rm) {
		final IMemoryDMContext memContext = DMContexts.getAncestorOfType(ctx, IMemoryDMContext.class);
		if (memContext == null) {
			rm.done();
			return;
		}

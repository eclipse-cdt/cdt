                                    ...
                                    if (launch != null) {
                                        try {
                                            ...
                                            if (reverseMode.equals(IGDBLaunchConfigurationConstants.DEBUGGER_REVERSE_MODE_SOFT)) {
                                                reverseService.enableReverseMode(fCommandControl.getContext(), CLIRecord.FULL_TRACE, rm);
                                                return;
                                            }
                                                    ...
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), CLIRecord.BRANCH_TRACE, rm);
                                                    ...
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), CLIRecord.PROCESSOR_TRACE, rm);
                                                    else
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), CLIRecord.GDB_TRACE, rm);
                                                return;
                                            }
                                            else {

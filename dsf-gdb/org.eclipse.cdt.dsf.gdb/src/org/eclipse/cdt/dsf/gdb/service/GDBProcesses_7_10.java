                                            ...
                                            if (reverseMode.equals(IGDBLaunchConfigurationConstants.DEBUGGER_REVERSE_MODE_SOFT)) {
                                                ...
                                                return;
                                                    ...
                                                    if(CDebugUIPlugin.getDefault().getPreferenceStore().getString(
                                                            ICDebugPreferenceConstants.PREF_REVERSE_TRACE_METHOD_HARDWARE).equals(
                                                                    ICDebugPreferenceConstants.PREF_REVERSE_TRACE_METHOD_BRANCH_TRACE))
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), ReverseTraceMethod.BRANCH_TRACE, rm);
                                                    else if(CDebugUIPlugin.getDefault().getPreferenceStore().getString(
                                                            ICDebugPreferenceConstants.PREF_REVERSE_TRACE_METHOD_HARDWARE).equals(
                                                                    ICDebugPreferenceConstants.PREF_REVERSE_TRACE_METHOD_PROCESSOR_TRACE))
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), ReverseTraceMethod.PROCESSOR_TRACE, rm);
                                                    else
                                                    reverseService.enableReverseMode(fCommandControl.getContext(), ReverseTraceMethod.GDB_TRACE, rm);
                                                return;
                                            }
                                            else {

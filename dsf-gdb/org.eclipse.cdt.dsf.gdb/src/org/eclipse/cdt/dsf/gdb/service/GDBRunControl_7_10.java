...
public class GDBRunControl_7_10 extends GDBRunControl_7_6 implements IReverseRunControl2 {
    ...
    private IReverseTraceMethod fReverseTraceMethod; // default: no trace
    ...
    private void doInitialize(RequestMonitor requestMonitor) {
        ...
        register(new String[]{ IRunControl2.class.getName() },
    ...
    @Override
    public void getReverseTraceMethod(ICommandControlDMContext context, DataRequestMonitor<IReverseTraceMethod> rm) {
        rm.setData(fReverseTraceMethod);
        rm.done();
    }

    @Override
    public void enableReverseMode(final ICommandControlDMContext context,final IReverseTraceMethod traceMethod, final RequestMonitor rm) {

...
public class GDBRunControl_7_10 extends GDBRunControl_7_6 implements IReverseRunControl2 {
    ...
    private int fReverseTraceMethod = -1; // default: no trace
     ...
     */
    @Override
    public void getReverseTraceMethod(ICommandControlDMContext context, DataRequestMonitor<Integer> rm) {
        rm.setData(fReverseTraceMethod);
        rm.done();
    }

    @Override
    public void enableReverseMode(final ICommandControlDMContext context,final int traceMethod, final RequestMonitor rm) {
        ...
        if(fReverseTraceMethod == -1 || traceMethod == -1) {
            ...
            getConnection().queueCommand(
                    fCommandFactory.createCLIRecord(context, -1),
                    new DataRequestMonitor<MIInfo>(getExecutor(), rm) {
                        @Override
                        public void handleSuccess() {

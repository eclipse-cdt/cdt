...
public class GDBSourceLookup extends CSourceLookup implements IGDBSourceLookup, IDebugSourceFiles, ICachingService {
	 ...
	 * @since 5.5
	 */
	public static IDebugSourceFileInfo createDebugSourceFileInfo(String file, String fullname) {
		SourceFileInfo srcFileInfo = new SourceFileInfo();
		srcFileInfo.setFile(file);
		srcFileInfo.setFullName(fullname);
		return new DebugSourceFileInfo(srcFileInfo);
	}

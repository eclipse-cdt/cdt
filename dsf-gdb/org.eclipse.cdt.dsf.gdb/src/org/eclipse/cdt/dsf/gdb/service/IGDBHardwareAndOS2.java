...
public interface IGDBHardwareAndOS2 extends IGDBHardwareAndOS {
    ...
    public interface ILoadInfo
    {
		...
		/**
		 * TODO: to be used to give more details about a CPU's/core's 
		 * load.  For instance the breakdown of the different load types and their
		 * proportion: system, user, I/O, interrupts, etc.
		 */

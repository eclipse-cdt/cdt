...
public interface IGDBSourceLookup extends ISourceLookup {
	...
	// TODO is it possible to remove this method?
	void sourceContainersChanged(ISourceLookupDirector director, RequestMonitor rm);
	 ...
	 * @param rm
	 */
	void sourceContainersChanged(ISourceLookupDMContext sourceLookupCtx, RequestMonitor rm);
}

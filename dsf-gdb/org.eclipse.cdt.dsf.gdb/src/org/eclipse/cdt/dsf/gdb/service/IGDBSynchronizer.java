...
public interface IGDBSynchronizer extends IDsfService {
	...
	/** 
     * This event interface indicates that GDB has switched its current thread, as a result 
    ...
    /** 
     * This event interface indicates that GDB has switched its current stack frame, as a result 
     * of an event not triggered by CDT - For example a console command.
     */

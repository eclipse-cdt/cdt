...
public interface IMultiTerminate {
    ...
    /**
     * Checks whether it is possible to terminate all of the specified threads.
     * 
     * @param dmcs The contexts of the threads to terminate
    ...
    /**
     * Request to terminate the specified threads. Only threads that can be terminated 
     * will be affected, others will be ignored.
     * 

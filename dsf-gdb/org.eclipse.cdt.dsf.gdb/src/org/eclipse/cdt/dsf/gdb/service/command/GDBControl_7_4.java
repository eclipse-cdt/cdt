...
import org.eclipse.cdt.dsf.gdb.launching.FinalLaunchSequence_7_4;
 ...
 * IBreakpointsTargetDMContext become the GDBControlContext.
 * 
 * @since 4.1
 */
public class GDBControl_7_4 extends GDBControl_7_2 implements IGDBControl {
	...
	protected Sequence getCompleteInitializationSequence(Map<String, Object> attributes, RequestMonitorWithProgress rm) {
		return new FinalLaunchSequence_7_4(getSession(), attributes, rm);
	}

...
import org.eclipse.cdt.dsf.gdb.service.GDBGrouping_7_11;
import org.eclipse.cdt.dsf.gdb.service.GdbDebugServicesFactory;
import org.eclipse.cdt.dsf.service.DsfSession;

/**
 * Top-level class in the version hierarchy of implementations of {@link IGdbGrouping}.
 * <br> 
 ...
 * @since 4.9
 */
public class GDBGrouping_HEAD extends GDBGrouping_7_11 {
	public GDBGrouping_HEAD(DsfSession session) {
		super(session);
		validateGdbVersion(session);
	}
	
	protected String getMinGDBVersionSupported() { return "7.9.50-itsets"; }

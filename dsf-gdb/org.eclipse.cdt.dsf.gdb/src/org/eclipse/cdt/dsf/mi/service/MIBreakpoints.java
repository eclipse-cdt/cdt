...
/**
 * Initial breakpoint service implementation. Implements the IBreakpoints
 * interface.
 */
public class MIBreakpoints extends AbstractDsfService
	 ...
	 * insert/updateBreakpoint(). All are optional with the possible exception of
	 * TYPE. It is the responsibility of the service to ensure that the set of
	 * attributes provided is sufficient to create/update a valid breakpoint on the
	 * back-end.
	 */
	...
	// The breakpoints are stored per context and keyed on the back-end breakpoint
	// reference
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.service.AbstractDsfService#initialize(org.eclipse.cdt.dsf
	 * .concurrent.RequestMonitor)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.service.AbstractDsfService#shutdown(org.eclipse.cdt.dsf.
	 * concurrent.RequestMonitor)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.debug.service.IBreakpoints#getBreakpoints(org.eclipse.cdt
	 * .dsf.debug.service.IBreakpoints.IBreakpointsTargetDMContext,
	 * org.eclipse.cdt.dsf.concurrent.DataRequestMonitor)
	 */
	@Override
	public void getBreakpoints(final IBreakpointsTargetDMContext context,
		...
		// If it doesn't exist then no breakpoint was ever inserted for this breakpoint
		// space.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.cdt.dsf.debug.service.IBreakpoints#getBreakpointDMData(org.
	 * eclipse.cdt.dsf.debug.service.IBreakpoints.IDsfBreakpointDMContext,
	 * org.eclipse.cdt.dsf.concurrent.DataRequestMonitor)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.debug.service.IBreakpoints#insertBreakpoint(org.eclipse.
	 * cdt.dsf.debug.service.IBreakpoints.IBreakpointsTargetDMContext,
	 * java.util.Map, org.eclipse.cdt.dsf.concurrent.DataRequestMonitor)
	 */
	@Override
	...
	/**
	 * Creates a gdb location string for a breakpoint/watchpoint/tracepoint given
	...
	protected void addBreakpoint(final IBreakpointsTargetDMContext context, final Map<String, Object> attributes,
		...
		// Extract the relevant parameters (providing default values to avoid potential
		// NPEs)
	...
	/**
	 * Add a tracepoint. Currently not supported in this version, but only in our
	 * GDB 7.0 version.
	 * 
	 * @param context
	 * @param attributes
	...
	protected void addWatchpoint(final IBreakpointsTargetDMContext context, final Map<String, Object> attributes,
		...
		DataRequestMonitor<MIBreakInsertInfo> addWatchpointDRM = new DataRequestMonitor<MIBreakInsertInfo>(
			...
			protected void handleSuccess() {
				...
				// Condition, ignore count and state can not be specified at watchpoint creation
				// time.
	...
	/**
	 * Adjust the expression to a format suitable for the debugger back end e.g.
	 * adding memory space, range, etc..
	 * 
	 * @since 5.3
	 */
	...
	/**
	 * Add a DynamicPrintf. Currently not supported in this version, but only in the
	 * GDB 7.7 version.
	 * 
	 * @since 4.4
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.debug.service.IBreakpoints#removeBreakpoint(org.eclipse.
	 * cdt.dsf.debug.service.IBreakpoints.IBreakpointDMContext,
	 ...
	 * 
	 * @see
	 * org.eclipse.cdt.dsf.debug.service.IBreakpoints#updateBreakpoint(org.eclipse.
	 * cdt.dsf.debug.service.IBreakpoints.IBreakpointDMContext, java.util.Map,
	 * org.eclipse.cdt.dsf.concurrent.RequestMonitor)
	 */
	@Override
	...
	protected void modifyBreakpoint(final IBreakpointDMContext dmc, Map<String, Object> attributes,
		...
		// Use a working copy of the attributes since we are going to tamper happily
		// with them
			...
			public void execute(final RequestMonitor rm) {
				...
				fConnection.queueCommand(fCommandFactory.createMIBreakCondition(context, reference, condition),
						new DataRequestMonitor<MIInfo>(getExecutor(), rm) {
							...
							// GDB "offers" different behaviours depending on its version: it can either
							// keep
	...
	/**
	 * See https://bugs.eclipse.org/bugs/show_bug.cgi?id=232415 Returns the simple
	 * filename if running on Windows and [originalPath] is not an absolute UNIX
	 * one. Otherwise, [originalPath] is returned
	 * 
	 * @since 4.2
	 */
	@Override

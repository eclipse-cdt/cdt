...
public class MIExpressions extends AbstractDsfService implements IMIExpressions, ICachingService {
    ...
    protected static class IndexedPartitionDMC extends MIExpressionDMC implements IIndexedPartitionDMContext {
    	...
    	public IndexedPartitionDMC(
    			...
    			int index, 
    			int length) {
    		this(parentExpr, (IDMContext)frameCtx, index, length);
    	}
    	/**
    	...
    	/**
    	 * @deprecated Replaced by getParentExpressionContext().  The new method not only gives
    	 * access to the parent ExpressionInfo, but also to the type of MIExpressionDMC,
    	 * which can be used to know if the parent is casted.
    	 */
    	@Deprecated
...
//		}
	...
	private IndexedPartitionDMC createIndexedPartition(MIExpressionDMC parentExpr, int index, int length) {
	    ...
	    if (frameDmc != null) {
	        return new IndexedPartitionDMC(parentExpr, frameDmc, index, length);
	    } 
        ...
        return new IndexedPartitionDMC(parentExpr, parentExpr, index, length);
	}

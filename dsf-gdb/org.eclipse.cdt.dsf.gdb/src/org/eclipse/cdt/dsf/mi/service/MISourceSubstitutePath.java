 ...
 * @since 4.9
 */
public class MISourceSubstitutePath extends AbstractDsfService implements ISourceSubstitutePath {

	private ICommandControl fCommand;
	private CommandFactory fCommandFactory;

	public MISourceSubstitutePath(DsfSession session) {
		super(session);
	}
	...
	private void doInitialize(final RequestMonitor rm) {
		...
		register(new String[] { MISourceSubstitutePath.class.getName(), ISourceSubstitutePath.class.getName() },

                        ...
                        if (getMITracingStream() != null) {
                        	try {
                        		...
                        		try {
                					...
                					initialMaxLines = node.getInt(IGdbDebugPreferenceConstants.PREF_MAX_MI_OUTPUT_LINES, 10000);
                        		...
                        		if (linecounter <= 0) {
                        			getMITracingStream().write(("[output truncated to "+ initialMaxLines +" lines. For more lines set the PREF_MAX_MI_OUTPUT_LINES in the eclipse preference page.]\n").getBytes()); //$NON-NLS-1$ //$NON-NLS-2$
                        		} else {

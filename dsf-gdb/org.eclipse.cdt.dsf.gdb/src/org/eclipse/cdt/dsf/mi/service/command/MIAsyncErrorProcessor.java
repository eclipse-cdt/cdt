...
public class MIAsyncErrorProcessor implements IEventProcessor {
	...
	final private IMICommandControl fCommandControl;

	private Map<IExecutionDMContext, Integer> fRunCommands = new HashMap<IExecutionDMContext, Integer>();

	public MIAsyncErrorProcessor(IMICommandControl commandControl) {
		super();
	...
	protected void fireStoppedEvent(final MIOutput output, final IExecutionDMContext ctx) {
		final DsfSession session = DsfSession.getSession(ctx.getSessionId());

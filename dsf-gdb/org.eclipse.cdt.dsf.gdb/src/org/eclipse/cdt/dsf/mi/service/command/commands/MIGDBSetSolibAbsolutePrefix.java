...
import org.eclipse.cdt.dsf.mi.service.command.commands.MIGDBSetSysroot.MIBasicAdjustable;
/**
 *
...
public class MIGDBSetSolibAbsolutePrefix extends MIGDBSet {
	...
	public MIGDBSetSolibAbsolutePrefix(ICommandControlDMContext ctx, String prefix) {
		super(ctx, new String[] {"solib-absolute-prefix", prefix}, x-> new MIBasicAdjustable(x)); //$NON-NLS-1$
	}

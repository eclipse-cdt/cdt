...
public class MIGDBSetSysroot extends MIGDBSet
{
	public MIGDBSetSysroot(ICommandControlDMContext ctx, String path) {
		super(ctx, new String[] {"sysroot", path}, x-> new MIBasicAdjustable(x));//$NON-NLS-1$
	}
	...
	public static class MIBasicAdjustable extends MIStandardParameterAdjustable{

		public MIBasicAdjustable(String parameter) {
			super(parameter);
		}

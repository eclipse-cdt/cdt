...
public class MIListThreadGroups extends MICommand<MIListThreadGroupsInfo> {
	...
	public enum GroupType {
		...
		GROUP_TYPE_BUILTIN("built-in"), // TODO: for future use //$NON-NLS-1$
	...
	private MIListThreadGroups(ICommandControlDMContext ctx, String groupId, boolean listAll, boolean recurse, GroupType type) {

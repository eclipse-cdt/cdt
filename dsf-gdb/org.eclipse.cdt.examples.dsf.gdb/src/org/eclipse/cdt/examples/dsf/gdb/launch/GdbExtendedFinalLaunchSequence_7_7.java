...
public class GdbExtendedFinalLaunchSequence_7_7 extends FinalLaunchSequence_7_7 {
	...
	protected String[] getExecutionOrder(String group) {
		if (GROUP_TOP_LEVEL.equals(group)) {
			...
			// As the first operation to do, print the version of GDB to the gdb console
			orderList.add(orderList.indexOf("stepSourceGDBInitFile") + 1, "stepPrintVersion"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void rollBackInitializeExtendedFinalLaunchSequence_7_7(RequestMonitor requestMonitor) {
...
//				});
	...
	@Execute
	public void stepCleanupExtendedFinalLaunchSequence_7_7(final RequestMonitor requestMonitor) {
		if (fTracker != null) fTracker.dispose();
		fTracker = null;
		requestMonitor.done();
	}

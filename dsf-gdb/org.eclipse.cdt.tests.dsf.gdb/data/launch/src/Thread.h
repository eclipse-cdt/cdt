...
/*
 * This file provides a simple and incomplete compatibility layer for
 * thread-related operations. This should help avoiding platform
 * dependent code in tests.
 */
 ...
 * return THREAD_DEFAULT_RET, which is defined according to the platform
 * type.
 *
 ...
 */
typedef ThreadRet (*ThreadFunc)(void *);

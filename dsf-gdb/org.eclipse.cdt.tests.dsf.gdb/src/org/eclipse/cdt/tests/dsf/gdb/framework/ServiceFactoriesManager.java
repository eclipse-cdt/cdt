 ...
 * code paths.
 * 
 * The test is in charge to provide a unique id for the given factory, however this class will trigger an
 ...
 * 
 * Users can then retrieved/remove the registered factory via the unique factory id provided by the test
 */

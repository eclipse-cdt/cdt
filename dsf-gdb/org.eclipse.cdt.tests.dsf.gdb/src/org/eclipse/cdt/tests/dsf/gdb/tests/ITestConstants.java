...
public class ITestConstants {
	...
	public static String[] ALL_SUPPORTED_VERSIONS = new String[] {
			...
			ITestConstants.SUFFIX_GDB_12, ITestConstants.SUFFIX_GDB_11, ITestConstants.SUFFIX_GDB_10,
			ITestConstants.SUFFIX_GDB_9, ITestConstants.SUFFIX_GDB_8_3, ITestConstants.SUFFIX_GDB_8_2,
			ITestConstants.SUFFIX_GDB_8_1, ITestConstants.SUFFIX_GDB_8_0, };

...
public class MIRegistersTest extends BaseTestCase {
	...
	/*
	 * This is a common support method which gets the Registers associated to a given group
	 */
	private IRegisterDMContext[] getRegisters(final IRegisterGroupDMContext groupDmc) throws Throwable {
	...
	private void writeRegister(IFrameDMContext frameDmc, final int regIndex, final String regValue, final String formatId) throws Throwable {
		...
		Query<Object> queryAction = new Query<Object>() {
			...
			protected void execute(DataRequestMonitor<Object> rm) {
				fRegService.writeRegister(regDMCs[regIndex], regValue, formatId, rm);
			}
		};
	...
	public void addRegisterGroupProposedName() throws Throwable {
		...
		assertEquals("Proposed group name shall be the same until is actually used", groupName, groupName2);

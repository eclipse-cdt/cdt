...
public class ProcStatParserTest  extends TestCase {
	...
	private ProcStatParser procStatParser = null;
	
//	@BeforeClass
//	public static void init_once() {
//		System.out.println("in init_once");
...
//    public void init() {
//		// new parser
//		procStatParser = new ProcStatParser();
//    }
	
	@Test
	public void testProcStatParse1() {
		// generate test input files
		writeStr2File(stat_t0, stat_t0_file);
		writeStr2File(stat_t1, stat_t1_file);
    	...
    	int l0 = (int)load.get("cpu0").floatValue();
		assertEquals(8,l0);
		int l1 = (int)load.get("cpu1").floatValue();
		assertEquals(4,l1);
		int l2 = (int)load.get("cpu2").floatValue();
		assertEquals(5,l2);
		int l3 = (int)load.get("cpu3").floatValue();
		assertEquals(5,l3);
	...
	@Test
	public void testProcStatParse2() {
        // generate test input files
		writeStr2File(stat_t1, stat_t1_file);
		writeStr2File(stat_t2, stat_t2_file);
	...
	@Test
	public void testProcStatParse3() {
        // generate test input files
		writeStr2File(stat_t0, stat_t0_file);
		writeStr2File(stat_t2, stat_t2_file);
	...
	@Test
	public void testProcStatParseOneSetOfCounters() {
	...
	@Test
	public void testStatFileDoesNotExist() {

...
public class ProcStatParserTest {
	...
	final static String stat_wong_content = "cpu  27602962 16857 1627282 178835528 958483 10 21256 0 0 0\n" +
	...
	public static void init_once() {
		...
		writeStr2File(stat_wong_content, stat_wrong_content_file);
	}

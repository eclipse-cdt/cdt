...
public class SourceLookupTest extends BaseTestCase {
	 ...
	 * found when stopped at main by either GDB directly or with the source
	 * lookup director.
	 */
	@Test
	 ...
	 * GDB does not locate the file, but the source lookup director does find
	 * the file.
	 */
	@Test
	 ...
	 * lookup director does find the file.
	 * 
	...
	/**
	 * Test with default source locators and a source substitution
	 * {@link SourceSubstitutePathSourceContainer} from BUILD_ABSPATH ->
	 * SOURCE_ABSPATH that GDB does locate the file, and the source lookup
	 * director does find the file.
	 * 
	 * Note in this case that the source lookup director finds the file with the
	 * {@link AbsolutePathSourceContainer}, not the
	 * {@link SourceSubstitutePathSourceContainer} as the latter has told GDB to
	 * perform substitutions and the correct absolute path has been returned to
	 * CDT. See
	 * {@link SourceSubstitutePathEntrySourceContainer#findSourceElements(String)}
	 */
	@Test

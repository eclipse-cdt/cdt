...
import org.eclipse.cdt.tests.dsf.mi.service.command.MIAsyncErrorProcessorTest;
...
@Suite.SuiteClasses({
		...
		ThreadStackFrameSyncTest.class, CommandLineArgsTest.class, MIAsyncErrorProcessorTest.class

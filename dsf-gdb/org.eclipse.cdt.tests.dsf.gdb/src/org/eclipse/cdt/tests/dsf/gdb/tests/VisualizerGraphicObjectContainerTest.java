...
import org.eclipse.cdt.visualizer.ui.canvas.GraphicObjectContainer;
import org.eclipse.swt.graphics.Rectangle;
import org.junit.Test;

public class VisualizerGraphicObjectContainerTest {


	// testcases

	/**
	 * Test that GraphicObjectContainer objects scale correctly.
	 ...
	 */
	@Test
	public void testGraphicObjectContainerRelativeSizingAndRetrieval() throws Exception {

		// we create the graphical objects with no margin, so as to make the sizes
		// easier to predict / understand,  for this test
		GraphicObjectContainer containerA = new GraphicObjectContainer(true, 0);
		GraphicObjectContainer containerB = new GraphicObjectContainer(true, 0);
		GraphicObjectContainer containerC = new GraphicObjectContainer(true, 0);
		GraphicObjectContainer containerD = new GraphicObjectContainer(true, 0);
		GraphicObjectContainer containerE = new GraphicObjectContainer(true, 0);
		GraphicObjectContainer containerF = new GraphicObjectContainer(true, 0);
		...
		GraphicObjectContainer obj = containerA.getObject("D");

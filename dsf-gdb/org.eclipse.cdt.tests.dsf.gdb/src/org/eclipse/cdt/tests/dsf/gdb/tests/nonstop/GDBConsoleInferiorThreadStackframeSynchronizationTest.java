...
import org.eclipse.cdt.dsf.gdb.service.GDBSynchronizer.StackFrameSwitchedEvent;
import org.eclipse.cdt.dsf.gdb.service.GDBSynchronizer.ThreadSwitchedEvent;
...
public class GDBConsoleInferiorThreadStackframeSynchronizationTest extends BaseParametrizedTestCase {
...
//	private IExecutionDMContext[] fThreadExecDmcArray = new IExecutionDMContext[5];
	...
	public void doBeforeTest() throws Exception {
		...
		Runnable runnable = new Runnable() {
			...
			public void run() {
                ...
                fSession.addServiceEventListener(GDBConsoleInferiorThreadStackframeSynchronizationTest.this, null);
			}
		};
	...
	public void doAfterTest() throws Exception {
		...
		if (fSession != null) {
			fSession.getExecutor().submit(() -> fSession.removeServiceEventListener(GDBConsoleInferiorThreadStackframeSynchronizationTest.this))
					.get();
		}
	...
	private String switchThreadAndCaptureThreadSwitchedEvent(String tid) throws Throwable {
		...
		IExecutionDMContext ctx = waitForEvent(ThreadSwitchedEvent.class).getDMContext(); 
	...
	private String switchFrameAndCaptureStackFrameSwitchedEvent(String frameLevel) throws Throwable {
		...
		IFrameDMContext ctx = waitForEvent(StackFrameSwitchedEvent.class).getDMContext(); 

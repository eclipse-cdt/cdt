...
public class ThreadStackFrameSyncTest extends BaseParametrizedTestCase {
	...
	public void testGdbSyncServiceCanSwitchGDBThread() throws Throwable {
		...
		fGdbSync.setGDBSelection(new Object[] {getContextForThreadId(5)});
		assertEquals("5", getCurrentThread());
		
		fGdbSync.setGDBSelection(new Object[] {getContextForThreadId(4)});
		assertEquals("4", getCurrentThread());
		
		fGdbSync.setGDBSelection(new Object[] {getContextForThreadId(3)});
		assertEquals("3", getCurrentThread());
		
		fGdbSync.setGDBSelection(new Object[] {getContextForThreadId(2)});
		assertEquals("2", getCurrentThread());
		
		fGdbSync.setGDBSelection(new Object[] {getContextForThreadId(1)});

...
public class SourceLookupTest_6_6 extends SourceLookupTest {
	 ...
	 */
	@Ignore("Not supported because GDB < 6.8 does not properly support non-canonical absolute paths.")
	@Test
	@Override
	 ...
	 * works fine in this case.
	 */
	@Ignore("Not supported because GDB < 7.6 does not properly support non-canonical relative paths.")
	@Test
	@Override

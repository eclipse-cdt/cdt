...
public class GDBRemoteTracepointsTest_7_4 extends GDBRemoteTracepointsTest_7_3 {
	...
	public void tracepointActionsWithCollectStrings() throws Throwable {
		...
		dataArray.add(new TracepointData(SOURCE_NAME, LINE_NUMBER_2, NO_CONDITION, 0, true, action1.toString(), false));
		dataArray.add(new TracepointData(SOURCE_NAME, LINE_NUMBER_3, NO_CONDITION, 0, true, action2.toString(), false));
		dataArray.add(new TracepointData(SOURCE_NAME, LINE_NUMBER_4, NO_CONDITION, 0, true, action1.toString(), true));
		dataArray.add(new TracepointData(SOURCE_NAME, LINE_NUMBER_1, NO_CONDITION, 0, true, action1.toString(), true));
		dataArray.add(new TracepointData(SOURCE_NAME, LINE_LOOP_2, NO_CONDITION, 0, true, action2.toString(), acceptsFastTpOnFourBytes()));

...
public class MIAsyncErrorProcessorTests extends BaseTestCase {
	...
	public void executeTest() throws Throwable {
		 ...
		 */
		SyncUtil.addBreakpoint("*0x0");

		/*
		 * Test case 1
		 * ===========
		 *
		 * 6. Resume and make sure the target is still suspended and reason is error
		 */
		SyncUtil.resume();
		 ...
		 * ===========
		 *
		 * 7. Try to step return and make sure target is suspended and reason is error
		 */
		...
		/*
		 * 8. Remove all breakpoints and resume. Target should be in resumed state now
		 */
		commandControl.queueCommand(

					...
					protected void execute(final DataRequestMonitor<Object> rm) {
						...
						if (runControl != null) {
							try {
								...
								eMessage = new StringBuilder("Exception Message: " +  e.getMessage() + ", RunControl is: " + runControl); //$NON-NLS-1$ //$NON-NLS-2$
							}
						} else {
						...
						rm.setStatus(new Status(IStatus.ERROR, DsfUIPlugin.PLUGIN_ID, IDsfStatusConstants.NOT_SUPPORTED, eMessage.toString(), null)); //$NON-NLS-1$
						rm.done();
					}	
				};

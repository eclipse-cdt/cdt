...
public class DsfStepIntoSelectionHyperlinkDetector extends AbstractHyperlinkDetector {	
	private class DsfStepIntoSelectionHyperlink implements IHyperlink {
		 ...
		 * @param region
		 */
		public DsfStepIntoSelectionHyperlink(ITextSelection selection, ITextEditor editor, IDsfStepIntoSelection stepIntoSelectionCommand) {
		...
		public void open() {
			...
			if (resolveSelection.isSuccessful() && dmc != null) {
				...
				fStepIntoSelectionCommand.runToSelection(location.getFileName(), location.getLineNumber(), resolveSelection.getFunction(), dmc);
			} else {
				String message = null;
				if (dmc == null){
	...
	public IHyperlink[] detectHyperlinks(ITextViewer textViewer, final IRegion region, boolean canShowMultipleHyperlinks) {
		...
		return new IHyperlink[] {new DsfStepIntoSelectionHyperlink(selection, editor, stepIntoSelectionCommand) };
	}

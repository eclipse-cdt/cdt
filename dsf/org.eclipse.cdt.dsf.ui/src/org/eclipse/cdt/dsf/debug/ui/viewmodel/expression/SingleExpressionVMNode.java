...
public class SingleExpressionVMNode extends AbstractVMNode implements IElementLabelProvider {
    ...
    /**
     * Dummy expression string used to calculate the delta flags in event processing.
     */
    private static final SimpleExpression DELTA_EXPRESSION = new SimpleExpression("x"); //$NON-NLS-1$ 
    ...
    public int getDeltaFlags(Object event) {
        ...
        retVal = getExpressionVMProvider().getDeltaFlagsForExpression(DELTA_EXPRESSION, event);

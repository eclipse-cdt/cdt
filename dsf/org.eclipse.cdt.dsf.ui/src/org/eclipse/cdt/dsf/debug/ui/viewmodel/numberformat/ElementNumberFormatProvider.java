...
public class ElementNumberFormatProvider implements IElementFormatProvider
{
    ...
    private Dictionary<String, String> fFilterProperties = new Hashtable<>();
    ...
    protected void initialize() {
    	...
    	// however, the presentation context id returned by getPresentationContext().getId() is the
    	// same for cloned views even though the presentation context is different.
    	// Instead, we can use the title of the view, which is unique even for cloned views.
    	String provider = getVMProvider().getPresentationContext().getPart().getTitle();

...
public interface IModules2 extends IModules {
    ...
    /**
     * Event indicating a change in all the symbols of the symbol context.
     */
    public interface ISymbolsAllChangedDMEvent extends IDMEvent<ISymbolDMContext> {}

    /**
     * Indicates symbols were loaded for all modules.
     */
    public interface ISymbolsAllLoadedDMEvent extends ISymbolsAllChangedDMEvent {}

    /**
     * Indicates symbols were unloaded for all modules.
     */
    public interface ISymbolsAllUnloadedDMEvent extends ISymbolsAllChangedDMEvent {}

...
public interface IRegisters2 extends IRegisters {
	 ...
	 */
	public void getRegisterNames(IRegisterDMContext[] regDmcArray, DataRequestMonitor<IRegisterDMData[]> rm);
	 ...
	 * 
	 * @param rm - request monitor encapsulating the response i.e. proposed name
	 */
	public void proposeGroupName(DataRequestMonitor<String> rm);

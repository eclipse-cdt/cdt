...
public interface IRunControl3 extends IRunControl2 {
	 ...
	 */
	void canStepIntoSelection(IExecutionDMContext context, String sourceFile, Integer lineNumber, IFunctionDeclaration selectedFunction, DataRequestMonitor<Boolean> rm); 
	 ...
	 */
	void stepIntoSelection(IExecutionDMContext context, String sourceFile, int lineNumber, boolean skipBreakpoints, IFunctionDeclaration selectedFunction, RequestMonitor rm) throws OperationNotSupportedException; 
}

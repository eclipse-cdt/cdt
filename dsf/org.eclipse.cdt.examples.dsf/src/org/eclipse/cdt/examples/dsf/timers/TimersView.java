...
public class TimersView extends ViewPart {
	...
	private void makeActions() {
		...
		fToggleLayoutAction.setImageDescriptor(
				DsfExamplesPlugin.getDefault().getImageRegistry().getDescriptor(DsfExamplesPlugin.IMG_LAYOUT_TOGGLE));
		...
		fAddTimerAction.setImageDescriptor(getImage(DsfExamplesPlugin.IMG_TIMER));
		...
		fAddTriggerAction.setImageDescriptor(getImage(DsfExamplesPlugin.IMG_ALARM));

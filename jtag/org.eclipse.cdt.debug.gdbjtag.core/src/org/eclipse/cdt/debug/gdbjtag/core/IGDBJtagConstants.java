...
public interface IGDBJtagConstants {
	...
	/** @since 10.6*/
	public static final String ATTR_USE_EXTENDED_REMOTE_TARGET = Activator.PLUGIN_ID + ".useExtendedRemoteTarget"; //$NON-NLS-1$
	...
	/** @since 10.6*/
	public static final boolean DEFAULT_USE_EXTENDED_REMOTE_TARGET = false;

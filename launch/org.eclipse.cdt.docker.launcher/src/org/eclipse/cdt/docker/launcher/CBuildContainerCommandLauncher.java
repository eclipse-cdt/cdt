...
public class CBuildContainerCommandLauncher
	...
	public CBuildContainerCommandLauncher(String connectionName,
			String imageName) {
	...
	public Process execute(IPath commandPath, String[] args, String[] env,
		...
		if (connectionName == null)
			throw new CoreException(new Status(IStatus.ERROR,
					DockerLaunchUIPlugin.PLUGIN_ID,
					"connectionName must be non-null. Use system property to set connectionName:  -Dcbuild.docker.connectionName=unix:///var/run/docker.sock"));
		if (imageName == null)
			throw new CoreException(new Status(IStatus.ERROR,
					DockerLaunchUIPlugin.PLUGIN_ID,
					"imageName must be non-null. Use system property to set imageName:  -Dcbuild.docker.imageName=<imagename>"));

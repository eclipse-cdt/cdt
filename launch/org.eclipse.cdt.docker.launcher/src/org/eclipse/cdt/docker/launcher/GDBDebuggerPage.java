...
public class GDBDebuggerPage extends AbstractCDebuggerPage implements Observer {
	...
	final private static String DEFAULT_MI_PROTOCOL = MIUIMessages
			.getString("GDBDebuggerPage.12"); //$NON-NLS-1$
	...
	public void createMainTab(TabFolder tabFolder) {
		...
		Label label = ControlFactory.createLabel(subComp,
				MIUIMessages.getString("GDBDebuggerPage.3")); //$NON-NLS-1$
		...
		Button button = createPushButton(subComp,
				MIUIMessages.getString("GDBDebuggerPage.4"), null); //$NON-NLS-1$
		...
		label = ControlFactory.createLabel(subComp,
				MIUIMessages.getString("GDBDebuggerPage.6")); //$NON-NLS-1$
		gd = new GridData();
		// gd.horizontalSpan = 2;
		label.setLayoutData(gd);
		...
		button = createPushButton(subComp,
				MIUIMessages.getString("GDBDebuggerPage.7"), null); //$NON-NLS-1$
		button.addSelectionListener(new SelectionAdapter() {
	...
	protected void createBreakpointFullPathName(Composite parent) {
		fBreakpointsFullPath = createCheckButton(parent,
				MIUIMessages.getString("StandardGDBDebuggerPage.14")); //$NON-NLS-1$

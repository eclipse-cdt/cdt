...
/**
 * The dynamic debugger tab for remote launches using gdb server. The gdbserver
 * settings are used to start a gdbserver session on the remote and then to
 * connect to it from the host. The DSDP-TM project is used to accomplish this.
 */

...
public class LaunchImages {
	...
	public static String IMG_VIEW_PROFILER_TAB = NAME_PREFIX + "profiler_tab.gif"; //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_TAB_PROFILER = createManaged(T_TABS, IMG_VIEW_PROFILER_TAB);

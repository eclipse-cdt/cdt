...
public class StatementAssignmentDetailsPage extends AbstractFormPart implements IDetailsPage {
	...
	public void selectionChanged(IFormPart part, ISelection selection) {
		...
		String t = model.readModel(fInputURI, StatementAssignment.class, "",
	...
	public void createContents(Composite parent) {
		...
		section.setDescription("Details about Symbol Assignment");

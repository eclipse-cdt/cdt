...
public class StatementInputSectionDetailsPage extends AbstractFormPart implements IDetailsPage {
	...
	public void selectionChanged(IFormPart part, ISelection selection) {
		...
		String t = model.readModel(fInputURI, StatementInputSection.class, "",
	...
	public void createContents(Composite parent) {
		...
		section.setDescription("Details about Input Section");

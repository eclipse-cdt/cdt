...
public class Model implements ILinkerScriptModel {
	...
	private ListenerList<ILinkerScriptModelListener> listeners = new ListenerList<>();
	private IXtextModelListener xtextListener = event -> {
		for (ILinkerScriptModelListener listener : listeners) {
	...
	public void writeText(Object uri, String text) {
		...
		if (region != null) {
			try {
				...
				// TODO log: not reachable, this is the location we were just
				// given.
				e.printStackTrace();
			}
		}

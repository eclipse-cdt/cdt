...
public class LinkerScriptPackageImpl extends EPackageImpl implements LinkerScriptPackage
{
   ...
   * @generated
   */
  private EClass lParenthesizedExpressionEClass = null;
   ...
   * @generated
   */
  private EClass originCallEClass = null;
   ...
   * @generated
   */
  private EEnum wildcardSortEEnum = null;
   ...
   * @generated
   */
  public EAttribute getWildcard_PrimarySort()
  {
   ...
   * @generated
   */
  public EAttribute getWildcard_SecondarySort()
  {
    return (EAttribute)wildcardEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EClass getLParenthesizedExpression()
  {
    return lParenthesizedExpressionEClass;
  }
   ...
   * @generated
   */
  public EReference getLParenthesizedExpression_Exp()
  {
    return (EReference)lParenthesizedExpressionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getOriginCall()
  {
    return originCallEClass;
  }
   ...
   * @generated
   */
  public EAttribute getOriginCall_Memory()
  {
    return (EAttribute)originCallEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EEnum getWildcardSort()
  {
    return wildcardSortEEnum;
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(wildcardEClass, WILDCARD__PRIMARY_SORT);
    createEAttribute(wildcardEClass, WILDCARD__SECONDARY_SORT);
    ...
    lParenthesizedExpressionEClass = createEClass(LPARENTHESIZED_EXPRESSION);
    createEReference(lParenthesizedExpressionEClass, LPARENTHESIZED_EXPRESSION__EXP);

    lengthCallEClass = createEClass(LENGTH_CALL);
    createEAttribute(lengthCallEClass, LENGTH_CALL__MEMORY);

    originCallEClass = createEClass(ORIGIN_CALL);
    createEAttribute(originCallEClass, ORIGIN_CALL__MEMORY);
    ...
    // Create enums
    wildcardSortEEnum = createEEnum(WILDCARD_SORT);
  }
  ...
  public void initializePackageContents()
  {
    ...
    lParenthesizedExpressionEClass.getESuperTypes().add(this.getLExpression());
    lengthCallEClass.getESuperTypes().add(this.getLExpression());
    originCallEClass.getESuperTypes().add(this.getLExpression());
    ...
    initEAttribute(getWildcard_PrimarySort(), this.getWildcardSort(), "primarySort", null, 0, 1, Wildcard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWildcard_SecondarySort(), this.getWildcardSort(), "secondarySort", null, 0, 1, Wildcard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(lParenthesizedExpressionEClass, LParenthesizedExpression.class, "LParenthesizedExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLParenthesizedExpression_Exp(), this.getLExpression(), null, "exp", null, 0, 1, LParenthesizedExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(originCallEClass, OriginCall.class, "OriginCall", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOriginCall_Memory(), ecorePackage.getEString(), "memory", null, 0, 1, OriginCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEEnum(wildcardSortEEnum, WildcardSort.class, "WildcardSort");
    addEEnumLiteral(wildcardSortEEnum, WildcardSort.SORT_NONE);
    addEEnumLiteral(wildcardSortEEnum, WildcardSort.SORT);
    addEEnumLiteral(wildcardSortEEnum, WildcardSort.SORT_BY_NAME);
    addEEnumLiteral(wildcardSortEEnum, WildcardSort.SORT_BY_ALIGNMENT);
    addEEnumLiteral(wildcardSortEEnum, WildcardSort.SORT_BY_INIT_PRIORITY);

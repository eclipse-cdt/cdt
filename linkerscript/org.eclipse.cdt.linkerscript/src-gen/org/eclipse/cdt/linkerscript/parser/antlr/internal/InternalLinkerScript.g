...
@after {
	...
	(
		...
		{
			$current = $this_SizeofCall_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_LNumberLiteral_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_LParenthesizedExpression_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_LVariable_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;

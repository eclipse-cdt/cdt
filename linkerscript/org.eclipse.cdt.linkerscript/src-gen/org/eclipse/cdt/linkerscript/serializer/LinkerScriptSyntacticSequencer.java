...
public class LinkerScriptSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_StatementAnywhere_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1;
	protected AbstractElementAlias match_StatementCommand_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1;
	...
	protected void init(IGrammarAccess access) {
		...
		match_StatementAnywhere_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementAnywhereAccess().getCommaKeyword_0_2_0()), new TokenAlias(false, false, grammarAccess.getStatementAnywhereAccess().getSemicolonKeyword_0_2_1()));
		match_StatementCommand_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementCommandAccess().getCommaKeyword_0_2_0()), new TokenAlias(false, false, grammarAccess.getStatementCommandAccess().getSemicolonKeyword_0_2_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_StatementAnywhere_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1.equals(syntax))
				emit_StatementAnywhere_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_StatementCommand_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1.equals(syntax))
				emit_StatementCommand_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     (rule start) (ambiguity) 'AT' '(' exp=LExpression
	 *     (rule start) (ambiguity) 'LENGTH' '(' memory=ValidID
	 *     (rule start) (ambiguity) 'SIZEOF' '(' name=ValidID
	 ...
	 *     (rule start) (ambiguity) {LTernaryOperation.condition=}
	 */
	 ...
	 */
	protected void emit_StatementAnywhere_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     assignment=AssignmentRule (ambiguity) (rule end)
	 */
	protected void emit_StatementCommand_CommaKeyword_0_2_0_or_SemicolonKeyword_0_2_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}

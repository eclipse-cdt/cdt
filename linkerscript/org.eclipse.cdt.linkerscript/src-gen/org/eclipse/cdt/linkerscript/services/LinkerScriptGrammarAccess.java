...
public class LinkerScriptGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StatementCommandElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cSemicolonKeyword_0_2_0 = (Keyword)cAlternatives_0_2.eContents().get(0);
		private final Keyword cCommaKeyword_0_2_1 = (Keyword)cAlternatives_0_2.eContents().get(1);
	...
	public class InputSectionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cWildFileWildcardParserRuleCall_1_2_0 = (RuleCall)cWildFileAssignment_1_2.eContents().get(0);
		...
		private final RuleCall cSectionsWildcardParserRuleCall_1_4_0 = (RuleCall)cSectionsAssignment_1_4.eContents().get(0);
		...
		private final RuleCall cSectionsWildcardParserRuleCall_1_5_1_0 = (RuleCall)cSectionsAssignment_1_5_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_1_6 = (Keyword)cGroup_1.eContents().get(6);
		private final Group cGroup_2 = (Group)cAlternatives.eContents().get(2);
		...
		private final RuleCall cWildFileWildcardParserRuleCall_3_4_0 = (RuleCall)cWildFileAssignment_3_4.eContents().get(0);
		...
		private final RuleCall cSectionsWildcardParserRuleCall_3_6_0 = (RuleCall)cSectionsAssignment_3_6.eContents().get(0);
		...
		private final RuleCall cSectionsWildcardParserRuleCall_3_7_1_0 = (RuleCall)cSectionsAssignment_3_7_1.eContents().get(0);
		...
		//('INPUT_SECTION_FLAGS' '(' flags+=WildID ('&' flags+=WildID)* ')')? wildFile=Wildcard '(' sections+=Wildcard (','?
		//sections+=Wildcard)* ')' | {InputSectionFile} keep?='KEEP' '(' ('INPUT_SECTION_FLAGS' '(' flags+=WildID ('&'
		//flags+=WildID)* ')')? file=WildID ')' | {InputSectionWild} keep?='KEEP' '(' ('INPUT_SECTION_FLAGS' '(' flags+=WildID
		//('&' flags+=WildID)* ')')? wildFile=Wildcard '(' sections+=Wildcard (','? sections+=Wildcard)* ')' ')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//Wildcard
		public RuleCall getWildFileWildcardParserRuleCall_1_2_0() { return cWildFileWildcardParserRuleCall_1_2_0; }
		...
		//Wildcard
		public RuleCall getSectionsWildcardParserRuleCall_1_4_0() { return cSectionsWildcardParserRuleCall_1_4_0; }
		...
		//Wildcard
		public RuleCall getSectionsWildcardParserRuleCall_1_5_1_0() { return cSectionsWildcardParserRuleCall_1_5_1_0; }
		...
		//Wildcard
		public RuleCall getWildFileWildcardParserRuleCall_3_4_0() { return cWildFileWildcardParserRuleCall_3_4_0; }
		...
		//Wildcard
		public RuleCall getSectionsWildcardParserRuleCall_3_6_0() { return cSectionsWildcardParserRuleCall_3_6_0; }
		...
		//Wildcard
		public RuleCall getSectionsWildcardParserRuleCall_3_7_1_0() { return cSectionsWildcardParserRuleCall_3_7_1_0; }
	...
	public class WildcardElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameWildIDParserRuleCall_0_1_0 = (RuleCall)cNameAssignment_0_1.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cWildcardAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		private final Group cGroup_2 = (Group)cAlternatives.eContents().get(2);
		private final Action cWildcardAction_2_0 = (Action)cGroup_2.eContents().get(0);
		private final Assignment cPrimarySortAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cPrimarySortWildcardSortEnumRuleCall_2_1_0 = (RuleCall)cPrimarySortAssignment_2_1.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_2_2 = (Keyword)cGroup_2.eContents().get(2);
		private final Assignment cNameAssignment_2_3 = (Assignment)cGroup_2.eContents().get(3);
		private final RuleCall cNameWildIDParserRuleCall_2_3_0 = (RuleCall)cNameAssignment_2_3.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_2_4 = (Keyword)cGroup_2.eContents().get(4);
		private final Group cGroup_3 = (Group)cAlternatives.eContents().get(3);
		private final Action cWildcardAction_3_0 = (Action)cGroup_3.eContents().get(0);
		private final Assignment cPrimarySortAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cPrimarySortWildcardSortEnumRuleCall_3_1_0 = (RuleCall)cPrimarySortAssignment_3_1.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3_2 = (Keyword)cGroup_3.eContents().get(2);
		private final Assignment cSecondarySortAssignment_3_3 = (Assignment)cGroup_3.eContents().get(3);
		private final RuleCall cSecondarySortWildcardSortEnumRuleCall_3_3_0 = (RuleCall)cSecondarySortAssignment_3_3.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3_4 = (Keyword)cGroup_3.eContents().get(4);
		private final Assignment cNameAssignment_3_5 = (Assignment)cGroup_3.eContents().get(5);
		private final RuleCall cNameWildIDParserRuleCall_3_5_0 = (RuleCall)cNameAssignment_3_5.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_3_6 = (Keyword)cGroup_3.eContents().get(6);
		private final Keyword cRightParenthesisKeyword_3_7 = (Keyword)cGroup_3.eContents().get(7);
		private final Group cGroup_4 = (Group)cAlternatives.eContents().get(4);
		private final Action cWildcardAction_4_0 = (Action)cGroup_4.eContents().get(0);
		private final Assignment cPrimarySortAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final RuleCall cPrimarySortWildcardSortEnumRuleCall_4_1_0 = (RuleCall)cPrimarySortAssignment_4_1.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_4_2 = (Keyword)cGroup_4.eContents().get(2);
		private final Keyword cEXCLUDE_FILEKeyword_4_3 = (Keyword)cGroup_4.eContents().get(3);
		private final Keyword cLeftParenthesisKeyword_4_4 = (Keyword)cGroup_4.eContents().get(4);
		private final Assignment cExcludesAssignment_4_5 = (Assignment)cGroup_4.eContents().get(5);
		private final RuleCall cExcludesWildIDParserRuleCall_4_5_0 = (RuleCall)cExcludesAssignment_4_5.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_4_6 = (Keyword)cGroup_4.eContents().get(6);
		private final Assignment cNameAssignment_4_7 = (Assignment)cGroup_4.eContents().get(7);
		private final RuleCall cNameWildIDParserRuleCall_4_7_0 = (RuleCall)cNameAssignment_4_7.eContents().get(0);
		...
		//{Wildcard} name=WildID | {Wildcard} 'EXCLUDE_FILE' '(' excludes+=WildID+ ')' name=WildID | {Wildcard}
		//primarySort=WildcardSort '(' name=WildID ')' | {Wildcard} primarySort=WildcardSort '(' secondarySort=WildcardSort '('
		//name=WildID ')' ')' | {Wildcard} primarySort=WildcardSort '(' 'EXCLUDE_FILE' '(' excludes+=WildID+ ')' name=WildID ')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//{Wildcard}
		public Action getWildcardAction_1_0() { return cWildcardAction_1_0; }
		...
		//{Wildcard}
		public Action getWildcardAction_2_0() { return cWildcardAction_2_0; }
		
		//primarySort=WildcardSort
		public Assignment getPrimarySortAssignment_2_1() { return cPrimarySortAssignment_2_1; }
		
		//WildcardSort
		public RuleCall getPrimarySortWildcardSortEnumRuleCall_2_1_0() { return cPrimarySortWildcardSortEnumRuleCall_2_1_0; }
		...
		//{Wildcard}
		public Action getWildcardAction_3_0() { return cWildcardAction_3_0; }
		
		//primarySort=WildcardSort
		public Assignment getPrimarySortAssignment_3_1() { return cPrimarySortAssignment_3_1; }
		
		//WildcardSort
		public RuleCall getPrimarySortWildcardSortEnumRuleCall_3_1_0() { return cPrimarySortWildcardSortEnumRuleCall_3_1_0; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_3_2() { return cLeftParenthesisKeyword_3_2; }
		
		//secondarySort=WildcardSort
		public Assignment getSecondarySortAssignment_3_3() { return cSecondarySortAssignment_3_3; }
		
		//WildcardSort
		public RuleCall getSecondarySortWildcardSortEnumRuleCall_3_3_0() { return cSecondarySortWildcardSortEnumRuleCall_3_3_0; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_3_4() { return cLeftParenthesisKeyword_3_4; }
		
		//name=WildID
		public Assignment getNameAssignment_3_5() { return cNameAssignment_3_5; }
		
		//WildID
		public RuleCall getNameWildIDParserRuleCall_3_5_0() { return cNameWildIDParserRuleCall_3_5_0; }
		...
		//{Wildcard}
		public Action getWildcardAction_4_0() { return cWildcardAction_4_0; }
		
		//primarySort=WildcardSort
		public Assignment getPrimarySortAssignment_4_1() { return cPrimarySortAssignment_4_1; }
		
		//WildcardSort
		public RuleCall getPrimarySortWildcardSortEnumRuleCall_4_1_0() { return cPrimarySortWildcardSortEnumRuleCall_4_1_0; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_4_2() { return cLeftParenthesisKeyword_4_2; }
		
		//'EXCLUDE_FILE'
		public Keyword getEXCLUDE_FILEKeyword_4_3() { return cEXCLUDE_FILEKeyword_4_3; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_4_4() { return cLeftParenthesisKeyword_4_4; }
		
		//excludes+=WildID+
		public Assignment getExcludesAssignment_4_5() { return cExcludesAssignment_4_5; }
		
		//WildID
		public RuleCall getExcludesWildIDParserRuleCall_4_5_0() { return cExcludesWildIDParserRuleCall_4_5_0; }
		
		//')'
		public Keyword getRightParenthesisKeyword_4_6() { return cRightParenthesisKeyword_4_6; }
		
		//name=WildID
		public Assignment getNameAssignment_4_7() { return cNameAssignment_4_7; }
		
		//WildID
		public RuleCall getNameWildIDParserRuleCall_4_7_0() { return cNameWildIDParserRuleCall_4_7_0; }
	...
	public class LUnaryOperationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLPrimaryExpressionParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//LPrimaryExpression
		public RuleCall getLPrimaryExpressionParserRuleCall_1() { return cLPrimaryExpressionParserRuleCall_1; }
	}
	...
	public class LPrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cOriginCallParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cAlignCallParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cSizeofCallParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cAtCallParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cLNumberLiteralParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cLParenthesizedExpressionParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		private final RuleCall cLVariableParserRuleCall_7 = (RuleCall)cAlternatives.eContents().get(7);
		...
		//OriginCall
		public RuleCall getOriginCallParserRuleCall_1() { return cOriginCallParserRuleCall_1; }
		
		//AlignCall
		public RuleCall getAlignCallParserRuleCall_2() { return cAlignCallParserRuleCall_2; }
		
		//SizeofCall
		public RuleCall getSizeofCallParserRuleCall_3() { return cSizeofCallParserRuleCall_3; }
		
		//AtCall
		public RuleCall getAtCallParserRuleCall_4() { return cAtCallParserRuleCall_4; }
		
		//LNumberLiteral
		public RuleCall getLNumberLiteralParserRuleCall_5() { return cLNumberLiteralParserRuleCall_5; }
		
		//LParenthesizedExpression
		public RuleCall getLParenthesizedExpressionParserRuleCall_6() { return cLParenthesizedExpressionParserRuleCall_6; }
		
		//LVariable
		public RuleCall getLVariableParserRuleCall_7() { return cLVariableParserRuleCall_7; }
	}
	...
	public class LParenthesizedExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cLParenthesizedExpressionAction_0 = (Action)cGroup.eContents().get(0);
		...
		//{LParenthesizedExpression}
		public Action getLParenthesizedExpressionAction_0() { return cLParenthesizedExpressionAction_0; }
	...
	public class OriginCallElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.cdt.linkerscript.LinkerScript.OriginCall");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cOriginCallAction_0 = (Action)cGroup.eContents().get(0);
		...
		//{OriginCall}
		public Action getOriginCallAction_0() { return cOriginCallAction_0; }
	...
	public class WildcardSortElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.cdt.linkerscript.LinkerScript.WildcardSort");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cSORT_NONEEnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
		private final Keyword cSORT_NONESORT_NONEKeyword_0_0 = (Keyword)cSORT_NONEEnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cSORTEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cSORTSORTKeyword_1_0 = (Keyword)cSORTEnumLiteralDeclaration_1.eContents().get(0);
		private final EnumLiteralDeclaration cSORT_BY_NAMEEnumLiteralDeclaration_2 = (EnumLiteralDeclaration)cAlternatives.eContents().get(2);
		private final Keyword cSORT_BY_NAMESORT_BY_NAMEKeyword_2_0 = (Keyword)cSORT_BY_NAMEEnumLiteralDeclaration_2.eContents().get(0);
		private final EnumLiteralDeclaration cSORT_BY_ALIGNMENTEnumLiteralDeclaration_3 = (EnumLiteralDeclaration)cAlternatives.eContents().get(3);
		private final Keyword cSORT_BY_ALIGNMENTSORT_BY_ALIGNMENTKeyword_3_0 = (Keyword)cSORT_BY_ALIGNMENTEnumLiteralDeclaration_3.eContents().get(0);
		private final EnumLiteralDeclaration cSORT_BY_INIT_PRIORITYEnumLiteralDeclaration_4 = (EnumLiteralDeclaration)cAlternatives.eContents().get(4);
		private final Keyword cSORT_BY_INIT_PRIORITYSORT_BY_INIT_PRIORITYKeyword_4_0 = (Keyword)cSORT_BY_INIT_PRIORITYEnumLiteralDeclaration_4.eContents().get(0);
		...
		//SORT_NONE
		public EnumLiteralDeclaration getSORT_NONEEnumLiteralDeclaration_0() { return cSORT_NONEEnumLiteralDeclaration_0; }
		
		//"SORT_NONE"
		public Keyword getSORT_NONESORT_NONEKeyword_0_0() { return cSORT_NONESORT_NONEKeyword_0_0; }
		
		//SORT
		public EnumLiteralDeclaration getSORTEnumLiteralDeclaration_1() { return cSORTEnumLiteralDeclaration_1; }
		
		//"SORT"
		public Keyword getSORTSORTKeyword_1_0() { return cSORTSORTKeyword_1_0; }
		
		//SORT_BY_NAME
		public EnumLiteralDeclaration getSORT_BY_NAMEEnumLiteralDeclaration_2() { return cSORT_BY_NAMEEnumLiteralDeclaration_2; }
		
		//"SORT_BY_NAME"
		public Keyword getSORT_BY_NAMESORT_BY_NAMEKeyword_2_0() { return cSORT_BY_NAMESORT_BY_NAMEKeyword_2_0; }
		
		//SORT_BY_ALIGNMENT
		public EnumLiteralDeclaration getSORT_BY_ALIGNMENTEnumLiteralDeclaration_3() { return cSORT_BY_ALIGNMENTEnumLiteralDeclaration_3; }
		
		//"SORT_BY_ALIGNMENT"
		public Keyword getSORT_BY_ALIGNMENTSORT_BY_ALIGNMENTKeyword_3_0() { return cSORT_BY_ALIGNMENTSORT_BY_ALIGNMENTKeyword_3_0; }
		
		//SORT_BY_INIT_PRIORITY
		public EnumLiteralDeclaration getSORT_BY_INIT_PRIORITYEnumLiteralDeclaration_4() { return cSORT_BY_INIT_PRIORITYEnumLiteralDeclaration_4; }
		
		//"SORT_BY_INIT_PRIORITY"
		public Keyword getSORT_BY_INIT_PRIORITYSORT_BY_INIT_PRIORITYKeyword_4_0() { return cSORT_BY_INIT_PRIORITYSORT_BY_INIT_PRIORITYKeyword_4_0; }
	}
	...
	private final WildcardSortElements eWildcardSort;
	...
	private final OriginCallElements pOriginCall;
	...
	public LinkerScriptGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.eWildcardSort = new WildcardSortElements();
		...
		this.pOriginCall = new OriginCallElements();
	...
	//enum WildcardSort:
	//	SORT_NONE | SORT | SORT_BY_NAME | SORT_BY_ALIGNMENT | SORT_BY_INIT_PRIORITY;
	public WildcardSortElements getWildcardSortAccess() {
		return eWildcardSort;
	}
	
	public EnumRule getWildcardSortRule() {
		return getWildcardSortAccess().getRule();
	}
	...
	//OriginCall LExpression:
	//	{OriginCall} 'ORIGIN' '(' memory=ValidID ')'
	public OriginCallElements getOriginCallAccess() {
		return pOriginCall;
	}
	
	public ParserRule getOriginCallRule() {
		return getOriginCallAccess().getRule();
	}

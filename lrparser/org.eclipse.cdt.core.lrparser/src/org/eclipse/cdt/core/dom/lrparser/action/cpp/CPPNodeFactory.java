...
public class CPPNodeFactory implements ICPPNodeFactory {
	...
	public ICPPASTOperatorName newOperatorName(OverloadableOperator oper) {
		return new CPPASTOperatorName(oper);
	}
	...
	public IASTProblemDeclaration newProblemDeclaration(IASTProblem problem) {
		CPPASTProblemDeclaration decl = new CPPASTProblemDeclaration();
		decl.setProblem(problem);
		return decl;
	}

	public IASTProblemExpression newProblemExpression(IASTProblem problem) {
		CPPASTProblemExpression decl = new CPPASTProblemExpression();
		decl.setProblem(problem);
		return decl;
	}

	public IASTProblemStatement newProblemStatement(IASTProblem problem) {
		CPPASTProblemStatement decl = new CPPASTProblemStatement();
		decl.setProblem(problem);
		return decl;
	}
...
//	}
	...
	public IGPPASTExplicitTemplateInstantiation newExplicitTemplateInstantiationGPP(IASTDeclaration declaration) {
		GPPASTExplicitTemplateInstantiation node = new GPPASTExplicitTemplateInstantiation();
	...
	public ICPPASTNamedTypeSpecifier newTypedefNameSpecifier(IASTName name) {
		CPPASTNamedTypeSpecifier node = new CPPASTNamedTypeSpecifier();
		node.setName(name);
		return node;
	}
	...
	public IGPPASTPointerToMember newPointerToMemberGPP(IASTName name) {
		GPPASTPointerToMember node = new GPPASTPointerToMember();
		node.setName(name);
		return node;
	}

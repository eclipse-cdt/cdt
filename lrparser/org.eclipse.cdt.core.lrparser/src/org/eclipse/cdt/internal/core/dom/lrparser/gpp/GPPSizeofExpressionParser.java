...
import org.eclipse.cdt.core.dom.ast.gnu.cpp.*;public class GPPSizeofExpressionParser extends PrsStream implements RuleAction, ITokenStream, 
...
private  GNUBuildASTParserAction  gnuAction;
    public void ruleAction(int ruleNumber)
    {
        switch (ruleNumber)
        {
            ...
            //
            // Rule 562:  type_name_specifier_inTemplate ::= dcolon_opt nested_name_specifier_opt_inTemplate type_name_inTemplate
            //
            case 562: { action.   consumeQualifiedId(false);             break;
            }  
  
            //
            // Rule 563:  type_name_specifier_inTemplate ::= dcolon_opt nested_name_specifier template template_id_name
            //
            ...
            //
            // Rule 636:  unary_expression ::= typeof unary_expression
            //
            case 636: { action.   consumeExpressionUnaryOperator(IASTUnaryExpression.op_typeof);             break;
            }  
  
            //
            // Rule 637:  relational_expression ::= relational_expression >? shift_expression
            //
            case 637: { action.   consumeExpressionBinaryOperator(IASTBinaryExpression.op_max);             break;
            }  
  
            //
            // Rule 638:  relational_expression ::= relational_expression <? shift_expression
            //
            case 638: { action.   consumeExpressionBinaryOperator(IASTBinaryExpression.op_min);             break;
            }  
  
            //
            // Rule 639:  conditional_expression ::= logical_or_expression ? <empty> : assignment_expression
            //
            case 639: { action.   consumeExpressionConditional();             break;
            }  
 
            //
            // Rule 640:  primary_expression ::= ( compound_statement )
            //
            case 640: {  gnuAction.consumeCompoundStatementExpression();            break;
            } 
  
            //
            // Rule 641:  labeled_statement ::= case case_range_expression : statement
            //
            case 641: { action.   consumeStatementCase();             break;
            }  
  
            //
            // Rule 642:  case_range_expression ::= constant_expression ... constant_expression
            //
            case 642: { action.   consumeExpressionBinaryOperator(IASTBinaryExpression.op_assign);             break;
            }  
  
            //
            // Rule 646:  typeof_type_specifier ::= typeof unary_expression
            //
            case 646: { action.   consumeExpressionUnaryOperator(IASTUnaryExpression.op_typeof);             break;
            }  
  
            //
            // Rule 647:  typeof_type_specifier ::= typeof ( type_id )
            //
            case 647: { action.   consumeExpressionTypeId(IASTTypeIdExpression.op_typeof);             break;
            }  
  
            //
            // Rule 648:  declaration_specifiers ::= <openscope-ast> typeof_declaration_specifiers
            //
            case 648: { action.   consumeDeclarationSpecifiersTypeof();             break;
            }  
  
            //
            // Rule 661:  declarator ::= <openscope-ast> ptr_operator_seq attribute_or_decl_specifier_seq direct_declarator
            //
            case 661: { action.   consumeDeclaratorWithPointer(true);             break;
            }  
  
            //
            // Rule 664:  simple_type_specifier ::= _Complex
            //
            case 664: { action.   consumeToken();            break;
            }  
  
            //
            // Rule 665:  simple_type_specifier ::= _Imaginary
            //
            case 665: { action.   consumeToken();            break;
            }  
  
            //
            // Rule 666:  cv_qualifier ::= restrict
            //
            case 666: { action.   consumeToken();            break;
            }  
  
            //
            // Rule 667:  explicit_instantiation ::= extern template declaration
            //
            case 667: { action.   consumeTemplateExplicitInstantiationGCC(IGPPASTExplicitTemplateInstantiation.ti_extern);             break;
            }  
  
            //
            // Rule 668:  explicit_instantiation ::= static template declaration
            //
            case 668: { action.   consumeTemplateExplicitInstantiationGCC(IGPPASTExplicitTemplateInstantiation.ti_static);             break;
            }  
  
            //
            // Rule 669:  explicit_instantiation ::= inline template declaration
            //
            case 669: { action.   consumeTemplateExplicitInstantiationGCC(IGPPASTExplicitTemplateInstantiation.ti_inline);             break;
            }  
  
            //
            // Rule 670:  postfix_expression ::= ( type_id ) initializer_list
            //
            case 670: { action.   consumeExpressionTypeIdInitializer();             break;
            }  
  
            //
            // Rule 672:  no_sizeof_type_id_start ::= ERROR_TOKEN
            //
            case 672: { action.   consumeEmpty();             break;
            }  

...
public class CPPLanguageServerPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void propertyChange(PropertyChangeEvent event) {
		if(event.getProperty() == serverChoice.VALUE && event.getSource() == serverChoice) {
			serverPath.setStringValue(CPPStreamConnectionProvider.getDefaultLSLocation((String) event.getNewValue()).getAbsolutePath());
			serverPath.load();
		}
	}

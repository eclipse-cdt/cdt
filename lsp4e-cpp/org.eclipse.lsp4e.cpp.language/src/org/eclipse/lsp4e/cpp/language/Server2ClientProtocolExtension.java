		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				...
				for (IWorkbenchWindow window : Workbenchwindows) {
					...
					if (statusLine.find(cqueryStatusFieldId) != null) {
						statusLine.remove(cqueryStatusFieldId);
					}
					StatusLineContributionItem cqueryStatusField = new StatusLineContributionItem(cqueryStatusFieldId, width);

...
@JsonAdapter(ExtendedSymbolKindDeserializer.class)
...
class ExtendedSymbolKindDeserializer implements JsonDeserializer<ExtendedSymbolKindType> {
	@Override
...
class ExtendedSymbolKindSerializer implements JsonSerializer<ExtendedSymbolKindType> {

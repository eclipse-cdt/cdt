/*******************************************************************************
 * Copyright (c) 2009, 2015, 2016 Wind River Systems, Inc. and others.etab
					...
					((IMemorySpaceAwareMemoryBlockRetrieval)retrieval).getMemorySpaces(context,
						new GetMemorySpacesRequest() {
							public void done() {
								...
								// get list of memory tabs stored in the launch
								...
								if (fLaunching && launch != null) {
									...
									try {
										...
										// do nothing.  we probably got here
										// because the context was not valid
										// and it failed to fetch the memory.
										// we will try to re-create the tabs

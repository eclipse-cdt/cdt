...
class PlainTextImport extends FileImport {

	private static final int BUFFER_LENGTH = 64 * 1024;

	private final IMemoryBlockExtension memoryBlock;

	PlainTextImport(File input, BigInteger start, IMemoryBlockExtension memoryBlock, Consumer<BigInteger> scroll) {
		super(input, start, scroll);

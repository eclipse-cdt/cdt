...
public class SRecordImporter implements IMemoryImporter {
	...
	public void importMemory() {
		SRecordImport sRecordImport = new SRecordImport((IMemoryBlockExtension) fMemoryBlock, fInputFile, fStartAddress,
			...
			job.addJobChangeListener(new JobChangeAdapter() {
				...
				public void done(IJobChangeEvent event) {
					if (event.getResult().isOK()) {
						fParentDialog.scrollRenderings(sRecordImport.recordAddress());
					}
				}
			});
		}

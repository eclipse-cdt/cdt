...
import org.eclipse.cdt.serial.BaudRateValues;
...
public class SerialSettingsPage extends AbstractSettingsPage {
	...
	public SerialSettingsPage(SerialSettings settings, IConfigurationPanel panel) {
		...
		if (baudRate <= 0) {
			baudRate = BaudRateValues.getDefaultBaudRate();
		}
	...
	public void createControl(Composite parent) {
		...
		baudRateCombo.setItems(BaudRateValues.getStandardBaudRatesAsStrings());
	...
	public void saveSettings() {
		...
		if (baudRateValue <= 0) {
			baudRateValue = BaudRateValues.getDefaultBaudRate();
		}

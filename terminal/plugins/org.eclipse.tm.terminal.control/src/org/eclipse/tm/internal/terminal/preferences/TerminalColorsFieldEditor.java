...
public class TerminalColorsFieldEditor extends FieldEditor {
	...
	protected void doLoad() {
		...
		colorSelectors.forEach((terminalColor, colorSelector) -> colorSelector
				.setColorValue(PreferenceConverter.getColor(store, terminalColor.getPreferenceName())));
	}
	...
	protected void doLoadDefault() {
		IPreferenceStore store = getPreferenceStore();
		colorSelectors.forEach((terminalColor, colorSelector) -> colorSelector
				.setColorValue(PreferenceConverter.getDefaultColor(store, terminalColor.getPreferenceName())));
	}
	...
	protected void doStoreDefault(IPreferenceStore store) {
		colorSelectors.forEach((terminalColor, colorSelector) -> store.setToDefault(terminalColor.getPreferenceName()));
	}
	...
	protected void doStore() {
		...
		colorSelectors.forEach((terminalColor, colorSelector) -> PreferenceConverter.setValue(store,
				terminalColor.getPreferenceName(), colorSelector.getColorValue()));
	}

...
public class TerminalColorsFieldEditor extends FieldEditor {
	...
	protected void doLoad() {
		...
		colorSelectors.forEach((terminalColor, colorSelector) -> colorSelector
				.setColorValue(PreferenceConverter.getColor(store, ITerminalConstants.getPrefForTerminalColor(terminalColor))));
	}
	...
	protected void doLoadDefault() {
		IPreferenceStore store = getPreferenceStore();
		colorSelectors.forEach((terminalColor, colorSelector) -> colorSelector
				.setColorValue(PreferenceConverter.getDefaultColor(store, ITerminalConstants.getPrefForTerminalColor(terminalColor))));
	}
	...
	protected void doStoreDefault(IPreferenceStore store) {
		colorSelectors.forEach((terminalColor, colorSelector) -> store.setToDefault(ITerminalConstants.getPrefForTerminalColor(terminalColor)));
	}

...
public interface ITerminalTextData extends ITerminalTextDataReadOnly {
	 ...
	 * @since 5.3
	 */
	void setCodePoints(int line, int column, int[] chars, TerminalStyle style);
	 ...
	 * @since 5.3
	 */
	void setCodePoints(int line, int column, int[] chars, int start, int len, TerminalStyle style);

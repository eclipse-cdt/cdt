...
import org.eclipse.launchbar.core.target.ILaunchTargetManager.TargetStatus;
...
public class ArduinoLaunchTargetProvider implements ILaunchTargetProvider {
	...
	public TargetStatus getStatus(ILaunchTarget target) {
		...
		return connection.getRemoteConnection().isOpen() ? TargetStatus.OK : TargetStatus.ERROR;
	}

	@Override
	public String getStatusMessage(ILaunchTarget target) {
		ArduinoRemoteConnection connection = target.getAdapter(ArduinoRemoteConnection.class);
		return connection.getRemoteConnection().isOpen() ? "OK" : "Not connected";
	}

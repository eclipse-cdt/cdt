	...
	implements IGraphicObject, ITooltipProvider
{
	...
	// pre-defined sub-object (e.g. image) positions/sizes
	/** Image occupies upper-left quadrant of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_UPPER_LEFT_QUADRANT = new Rectangle(0, 0, 50, 50);
	/** Image occupies upper-right quadrant of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_UPPER_RIGHT_QUADRANT = new Rectangle(50, 0, 50, 50);
	/** Image occupies lower-left quadrant of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_LOWER_LEFT_QUADRANT = new Rectangle(0, 50, 50, 50);
	/** Image occupies lower-right quadrant of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_LOWER_RIGHT_QUADRANT = new Rectangle(50, 50, 50, 50);

	/** Image occupies lower-right 1/8 of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_LOWER_RIGHT_HEIGHTH = new Rectangle(75, 75, 25, 25);
	/** Image occupies upper-left 7/8 of graphic object's space 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_UPPER_LEFT_SEVENTH_HEIGHTH = new Rectangle(0, 0, 75, 75);

	/** Image occupies the whole graphic object 
	 * @since 1.2*/
	public static final Rectangle IMGPOS_MAXSIZE = new Rectangle(0, 0, 100, 100);

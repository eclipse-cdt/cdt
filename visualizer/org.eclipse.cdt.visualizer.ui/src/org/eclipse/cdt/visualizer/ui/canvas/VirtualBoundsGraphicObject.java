...
public class VirtualBoundsGraphicObject extends GraphicObject {
	...
	public VirtualBoundsGraphicObject(boolean selectable, int margin) {
	...
	/**
	 * Sets whether the container's boundary should be drawed / filled-in.
	...
	/** Searches recursively for a child object matching a label.
     Returns null of object is not found */
